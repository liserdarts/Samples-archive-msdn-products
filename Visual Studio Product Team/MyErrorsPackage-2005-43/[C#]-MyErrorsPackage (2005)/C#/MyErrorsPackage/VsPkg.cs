// VsPkg.cs : Implementation of MyErrorsPackage
//
...
namespace Vsip.MyErrorsPackage
{
    ...
    [Guid("968ceb5d-9859-4d47-b6b0-d57ea8c184f2")]
    public sealed class MyErrorsPackage : Package
    {
        ...
        internal static string GetResourceString(string resourceName)
        {
            ...
            Guid packageGuid = typeof(MyErrorsPackage).GUID;
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidMyErrorsPackageCmdSet, (int)PkgCmdIDList.cmdidMyErrors);
