...
DeviceRetrieveDescriptor(
    ...
    _Outptr_result_maybenull_ PSTORAGE_DESCRIPTOR_HEADER* Descriptor
    );
...
DeviceSetMediaChangeStateEx(
    ...
    _Out_opt_ PMEDIA_CHANGE_DETECTION_STATE OldState
    );
