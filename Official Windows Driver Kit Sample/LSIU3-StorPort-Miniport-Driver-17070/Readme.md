# LSI_U3 StorPort Miniport Driver
## Requires
* Visual Studio 2013
## License
* MS-LPL
...
<div id="mainSection">
<p>The LSI_U3 sample is an adapter driver for use with Parallel SCSI Host Bus Adapters or on-motherboard solutions that use the LSI 53C1010 SCSI ASIC. These sources are presented for your education and use with these generally available LSI SCSI-class adapters.
 The intended use of this sample driver is for this purpose only.</p>
...
<p>The operation of this sample requires one of the following hardware items:</p>
<ul>
<li>Parallel SCSI Host Bus Adapter </li><li>On-motherboard solution that uses the LSI 53C1010 SCSI ASIC </li></ul>
<p>For more information, see <a href="http://msdn.microsoft.com/en-us/library/windows/hardware/ff567562">
Storport Miniport Drivers</a> in the storage technologies design guide.</p>
</div>
