...
--*/
{
    ...
    Overlap = NcComparePath( &ReturnedName,
...
--*/
{
    ...
    Overlap = NcComparePath( &FileInfo->Name,
...
--*/
{
    ...
    SrcRealOverlap = NcComparePath( &SrcInfo->Name,
                                    &InstanceContext->Mapping.RealMapping,
                                    NULL,
                                    IgnoreCase,
                                    TRUE );

    SrcUserOverlap = NcComparePath( &SrcInfo->Name,
                                    &InstanceContext->Mapping.UserMapping,
                                    NULL,
                                    IgnoreCase,
                                    TRUE );
    ...
    TargetRealOverlap = NcComparePath( &TargetInfo->Name,
                                       &InstanceContext->Mapping.RealMapping,
                                       &TargetRealRemainder,
                                       IgnoreCase,
                                       TRUE );

    TargetUserOverlap = NcComparePath( &TargetInfo->Name,
                                       &InstanceContext->Mapping.UserMapping,
                                       &TargetUserRemainder,
                                       IgnoreCase,
                                       TRUE );
