...
<div id="mainSection">
<p>The Delete minifilter is an example that demonstrates how to detect deletions of files or streams. Deletions are reported as debug output.
</p>
...
<p>The <i>delete</i> minifilter illustrates how to detect deletion of files and streams. It monitors IRP_MJ_CREATE requests for the FILE_DELETE_ON_CLOSE flag. Also, it detects IRP_MJ_SET_INFORMATION requests for setting FileDispositionInformation. The sample
 also illustrates how to handle racing deletes (in the form of multiple parallel IRP_MJ_SET_INFORMATION operations), and how to distinguish deletion of an entire file from deletion of just one stream of the file.
</p>
