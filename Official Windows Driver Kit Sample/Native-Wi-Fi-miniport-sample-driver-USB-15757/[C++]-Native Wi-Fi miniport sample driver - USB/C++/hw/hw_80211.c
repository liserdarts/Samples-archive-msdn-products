...
USHORT 
ComputeTxTime(
    _In_ USHORT   FrameLength,            //3in byte
    _In_ ULONG    DataRate,               //3in 0.5 Mbits
    _In_ BOOLEAN  bManagementFrame,
    _In_ BOOLEAN  bShortPreamble
    )
{
    USHORT          FrameTime;
...
ComputePLCPLength(
    _In_ USHORT       FrameLength,        //3in byte
    _In_ ULONG        DataRate,           //3in 0.5 Mbits
    _Out_ USHORT      *FrameTime,
    _Out_ USHORT      *LengExt 
    )
{
