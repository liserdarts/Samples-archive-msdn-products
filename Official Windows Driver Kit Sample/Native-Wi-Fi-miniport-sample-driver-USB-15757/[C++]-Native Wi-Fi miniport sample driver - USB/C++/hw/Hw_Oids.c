...
HwSetChannel(
    _In_  PNIC pNic,
    _In_  UCHAR ucChannel,
    _In_  HW_CHANNEL_SWITCH_COMPLETE_HANDLER ChannelSwitchCompleteHandler
    )
{
    //
...
HwTranslateChannelFreqToLogicalID(
    _In_  PULONG  pulChannelFreqList,
    _In_  ULONG   uNumChannels,
    _Out_ _Out_writes_(uNumChannels) PULONG  uLogicalChannelList
    )
{
...
{
    NDIS_STATUS         ndisStatus;
    UCHAR               ucChannel = 0, ucCurrentChannel = 0;
