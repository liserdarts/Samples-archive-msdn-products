...
HwEnableSendCTSToSelf(
    _In_  PNIC                    pNic,
    _In_  USHORT                  currentDataRate,
    _Out_ PUSHORT                 pRTSCTSRate
    )
{
...
Routine Description:       
  ...
  NdisRetreatNetBufferDataStart(
    NetBuffer,
    sizeof(TX_DESC_8187), //_In_ ULONG  DataOffsetDelta,
    0,
    NULL
    ); 
...
Hw11SendMgmtPacket(
                  _In_  PNIC            Nic,
                  _In_opt_  PSTA_BSS_ENTRY  pBSSEntry,
                  _In_  PUCHAR          pMgmtPacket,
                  _In_  USHORT          MgmtPacketLength
                  )
{
    PUCHAR              TxBuf;
    PUCHAR                  pDesc;
