...
Sta11ReadRegistryConfiguration(
    _In_ PSTATION         pStation,
    _In_ NDIS_HANDLE      hConfigurationHandle
    );
...
Sta11EnumerateBSSList(
    _In_  PSTATION         pStation,
    _Inout_ PDOT11_BYTE_ARRAY        pDot11ByteArray,
...
Sta11QueryDesiredSSIDList(
    _In_  PSTATION        pStation,
    _Out_ PDOT11_SSID_LIST    pDot11SSIDList,
    _In_  ULONG           TotalLength
    );
...
Sta11QueryExcludedMACAddressList(
    _In_  PSTATION        pStation,
    _Out_writes_bytes_(TotalLength) PDOT11_MAC_ADDRESS_LIST pDot11MacAddrList,
    _In_ _In_range_(sizeof(DOT11_MAC_ADDRESS_LIST) - sizeof(DOT11_MAC_ADDRESS), 0x7FFFFFFF) ULONG           TotalLength
    );
...
Sta11QueryDesiredBSSIDList(
    _In_  PSTATION        pStation,
    _Out_writes_bytes_(TotalLength) PDOT11_BSSID_LIST   pDot11BSSIDList,
    _In_ _In_range_(sizeof(DOT11_BSSID_LIST) - sizeof(DOT11_MAC_ADDRESS), 0x7FFFFFFF)  ULONG           TotalLength
    );
...
Sta11QueryEnabledAuthenticationAlgorithm(
    _In_  PSTATION        pStation,
    _Out_ PDOT11_AUTH_ALGORITHM_LIST  pAuthAlgoList,
    _In_  ULONG           TotalLength
    );
...
Sta11QuerySupportedUnicastAlgorithmPair(
    _In_  PSTATION        pStation,
    _Out_writes_bytes_(TotalLength) PDOT11_AUTH_CIPHER_PAIR_LIST    pAuthCipherList,
    _In_ _In_range_(sizeof(DOT11_AUTH_CIPHER_PAIR_LIST) - sizeof(DOT11_AUTH_CIPHER_PAIR), 0x7FFFFFFF) ULONG           TotalLength
    );
...
Sta11QueryEnabledUnicastCipherAlgorithm(
    _In_  PSTATION        pStation,
    _Out_ PDOT11_CIPHER_ALGORITHM_LIST  pAuthCipherList,
    _In_  ULONG           TotalLength
    );
...
Sta11QueryExtStaCapability(
    _In_  PSTATION        pStation,
    _Out_ PDOT11_EXTSTA_CAPABILITY   pDot11ExtStaCap
    );
...
Sta11QueryPrivacyExemptionList(
    _In_  PSTATION                      pStation,
    _Out_writes_bytes_(TotalLength) PDOT11_PRIVACY_EXEMPTION_LIST list,
    _In_ _In_range_(sizeof(DOT11_PRIVACY_EXEMPTION_LIST) - sizeof(DOT11_PRIVACY_EXEMPTION), 0x7FFFFFFF) ULONG                         TotalLength
    );
...
Sta11QueryDesiredPhyList(
    _In_  PSTATION        pStation,
    _Out_ PDOT11_PHY_ID_LIST  PhyIdList,
    _In_  ULONG           TotalLength
    );
...
Sta11QueryPMKIDList(
    _In_  PSTATION        pStation,
    _Out_writes_bytes_(TotalLength) PDOT11_PMKID_LIST  PMKIDList,
    _In_ _In_range_(sizeof(DOT11_PMKID_LIST) - sizeof(DOT11_PMKID_ENTRY), 0x7FFFFFFF) ULONG           TotalLength
    );
...
Sta11QueryMediaStreamingOption(
    _In_  PSTATION        pStation,
    _Out_ PBOOLEAN        mediaStreamingEnabled
    );
...
Sta11QueryUnicastUseGroupOption(
    _In_  PSTATION        pStation,
    _Out_  PBOOLEAN        unicastUseGroupEnabled
    );
...
Sta11QuerySafeModeOption(
    _In_  PSTATION        pStation,
    _Out_  PBOOLEAN        safeModeEnabled
    );
...
Sta11QueryHiddenNetworkOption(
    _In_  PSTATION        pStation,
    _Out_  PBOOLEAN        hiddenNetworkEnabled
    );
...
Sta11QueryDot11Statistics(
    _In_  PSTATION        pStation,
    _In_ PDOT11_STATISTICS pDot11Stats,
    _In_ ULONG InformationBufferLength,
...
Sta11SetOperationMode(
    _In_  PSTATION        pStation,
    _In_  PDOT11_CURRENT_OPERATION_MODE currentOperationMode
    );
...
Sta11SetDesiredSSIDList(
    _In_  PSTATION        pStation,
    _In_  PDOT11_SSID_LIST    pDot11SSIDList,
...
Sta11SetExcludedMACAddressList(
    _In_  PSTATION        pStation,
    _In_  PDOT11_MAC_ADDRESS_LIST pDot11MacAddrList,
    _Out_ PULONG          pBytesRead
    );
...
Sta11SetDesiredBSSIDList(
    _In_  PSTATION        pStation,
    _In_  PDOT11_BSSID_LIST   pDot11BSSIDList,
    _Out_ PULONG          pBytesRead
    );
...
Sta11SetEnabledAuthenticationAlgorithm(
    _In_  PSTATION        pStation,
    _In_  PDOT11_AUTH_ALGORITHM_LIST  pAuthAlgoList,
    _Out_ PULONG          pBytesRead
    );
...
Sta11SetEnabledUnicastCipherAlgorithm(
    _In_  PSTATION        pStation,
    _In_  PDOT11_CIPHER_ALGORITHM_LIST  pCipherAlgoList,
    _Out_ PULONG          pBytesRead
    );
...
Sta11SetCipherDefaultKey(
    _In_  PSTATION pStation,
    _In_  PDOT11_CIPHER_DEFAULT_KEY_VALUE defaultKey
    );
...
Sta11SetCipherKeyMappingKey(
    _In_  PSTATION pStation,
    _In_  PDOT11_CIPHER_KEY_MAPPING_KEY_VALUE pKeyMappingKeys,
    _In_  ULONG TotalLength
    );
...
Sta11SetPrivacyExemptionList(
    _In_  PSTATION                      pStation,
    _In_  PDOT11_PRIVACY_EXEMPTION_LIST list,
    _Out_ PULONG              pBytesRead
    );
...
Sta11SetIBSSParameters(
    _In_  PSTATION pStation,
    _In_  PDOT11_IBSS_PARAMS pDot11IBSSParams,
...
Sta11SetMediaStreamingOption(
    _In_  PSTATION        pStation,
    _In_  BOOLEAN         mediaStreamingEnabled
    );
...
Sta11SetPMKIDList(
    _In_  PSTATION            pStation,
    _In_  PDOT11_PMKID_LIST  PMKIDList,
    _Out_ PULONG              BytesRead
    );
...
Sta11SetUnicastUseGroupOption(
    _In_  PSTATION pStation,
    _In_  BOOLEAN  unicastUseGroupEnabled
    );
...
Sta11SetHiddenNetworkOption(
    _In_  PSTATION pStation,
    _In_  BOOLEAN  hiddenNetworkEnabled
    );
...
Sta11StartScan(
    ...
    _Out_ ULONG               ScanRequestBufferLength
    );
