...
Hw11AddAdapterResource(
    _In_ PNIC    pNic,
    _In_ PCM_PARTIAL_RESOURCE_DESCRIPTOR  pResource
    );
...
Hw11GrowFragmentPool(
    _In_ PNIC         pNic,
    _In_ ULONG        NumFragmentsToAllocate,
    _In_ ULONG        MaxFragmentsToAllocate
    );
...
Hw11CanTransmitNBL(
    ...
    _In_ PDOT11_EXTSTA_SEND_CONTEXT      Dot11SendContext
    );
...
Hw11FillReceiveContext(
    _In_  PNIC                        pNic,
    _In_  PNIC_RX_FRAGMENT            pNicFragment,
    _Inout_ PDOT11_EXTSTA_RECV_CONTEXT   Dot11RecvContext
    );
...
Hw11TransmitATIMPacket(
    _In_ PNIC                     pNic,
    _In_ PDOT11_MAC_ADDRESS       pDestinationMacAddress
    );
...
Hw11InterruptRecognized(
    _In_  PNIC            pNic,
    _Out_ PBOOLEAN        pbQueueMiniportHandleInterrupt
    );
...
Hw11QueryOpModeCap(
    _In_ PNIC pNic,
    _Out_ PDOT11_OPERATION_MODE_CAPABILITY pDot11OpModeCap
    );
...
Hw11QueryPowerMgmtMode(
    _In_ PNIC pNic,
    _Out_ PDOT11_POWER_MGMT_MODE pDot11PowerMgmtMode
    );
...
Hw11QueryRecvSensitivityList(
    _In_ PNIC pNic,
    _In_ ULONG uMaxEntries,
    _Inout_ PDOT11_RECV_SENSITIVITY_LIST pDot11RecvSensitivityList
    );

VOID
Hw11QueryOperationalRateSet(
    _In_  PNIC            pNic,
    _Out_ PDOT11_RATE_SET pDot11RateSet,
    _In_  BOOLEAN         selectedPhy 
    );
...
Hw11SetOperationalRateSet(
    _In_  PNIC            pNic,
    _In_  PDOT11_RATE_SET pDot11RateSet,
    _In_  BOOLEAN         selectedPhy 
    );
...
Hw11QueryOptionalCapability(
    _In_ PNIC pNic,
    _Out_ PDOT11_OPTIONAL_CAPABILITY pDot11OptionalCapability
    );

NDIS_STATUS
Hw11QueryCurrentOptionalCapability(
    _In_ PNIC pNic,
    _In_ PDOT11_CURRENT_OPTIONAL_CAPABILITY pDot11CurrentOptionalCapability
    );
...
Hw11QuerySupportedPowerLevels(
    _In_ PNIC pNic,
    _Out_ PDOT11_SUPPORTED_POWER_LEVELS pDot11SupportedPowerLevels
    );
...
Hw11QueryRegDomainsSupportValue(
    _In_ PNIC pNic,
    _In_ ULONG uNumMaxEntries,
    _Out_writes_(uNumMaxEntries) PDOT11_REG_DOMAINS_SUPPORT_VALUE pDot11RegDomainsSupportValue
    );
...
Hw11QuerySupportedTXAntenna(
    _In_ PNIC pNic,
    _In_ ULONG uNumMaxEntries,
    _Out_writes_(uNumMaxEntries) PDOT11_SUPPORTED_ANTENNA_LIST pDot11SupportedAntennaList
    );
...
Hw11QueryDiversitySelectionRX(
    _In_ PNIC pNic,
    _In_ ULONG uNumMaxEntries,
    _Out_writes_(uNumMaxEntries) PDOT11_DIVERSITY_SELECTION_RX_LIST pDot11DiversitySelectionRXList
    );

VOID
Hw11QueryStationId(
    _In_ PNIC pNic,
    _In_ DOT11_MAC_ADDRESS Dot11MacAddress
    );

VOID
Hw11QueryPnPCapabilities(
    _In_ PNIC     pNic,
    _Out_ PNDIS_PNP_CAPABILITIES pNdisPnPCapabilities
    );

NDIS_STATUS
Hw11QueryLinkParameters(
    _In_ PNIC     pNic,
    _Out_ PNDIS_LINK_PARAMETERS      pLinkParams
    );

NDIS_STATUS
Hw11SetLinkParameters(
    _In_ PNIC     pNic,
    _In_ PNDIS_LINK_PARAMETERS      pLinkParams
    );
...
Hw11QuerySupportedPHYTypes(
    _In_ PNIC pNic,
    _In_ ULONG uNumMaxEntries,
    _Out_ PDOT11_SUPPORTED_PHY_TYPES pDot11SupportedPhyTypes
    );
...
Hw11SetDevicePowerState(
    _In_  PNIC                        pNic,
    _In_  NDIS_DEVICE_POWER_STATE     DevicePowerState
    );
...
Hw11JoinAdHoc(
    _In_  PNIC                     pNic,
    _In_  PDOT11_BSS_DESCRIPTION  BSSDescription
    );
...
Hw11SetPowerMgmtMode(
    _In_  PNIC pNic,
    _In_  PDOT11_POWER_MGMT_MODE pDot11PowerMgmtMode
    );

VOID
Hw11QuerySupportedDataRatesValue(
    _In_  PNIC                                    pNic,
    _Out_ PDOT11_SUPPORTED_DATA_RATES_VALUE_V2    pDot11SupportedDataRatesValue,
    _In_  BOOLEAN                                 selectedPhy 
    );
...
Hw11SecurityCheck(
    ...
    _In_ PNIC_RX_FRAGMENT    *ppNicFragment,
    _In_ ULONG                FragmentCount
    );
...
Hw11SetTXDataRate(
                 _In_ PNIC Nic,
                 _In_ PDOT11_RATE_SET APRateSet,
