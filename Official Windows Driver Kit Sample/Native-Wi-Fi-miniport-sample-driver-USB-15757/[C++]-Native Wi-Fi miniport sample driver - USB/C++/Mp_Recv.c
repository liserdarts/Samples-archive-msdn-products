...
MpAddRxFragmentToMSDU(
    ...
    _In_  USHORT                      usFragmentSize,
    _In_  UCHAR                       ucFragNumber
    )
{
...
MpFindPartialMSDUInReassemblyLine(
    _In_ PADAPTER     pAdapter,
    _In_ PMP_DOT11_MGMT_DATA_MAC_HEADER pFragmentHdr,
    _In_ USHORT       usSequenceNumber
    )
{
    PMP_RX_MSDU pMpRxd;
    USHORT      i;
...
NDIS_STATUS
 Mp11AssociateRxFragment(
    _In_  PADAPTER         pAdapter,
    _In_  PNIC_RX_FRAGMENT Fragment,
    _Outptr_result_maybenull_ PMP_RX_FRAGMENT* ppMpFragment
    )
{
    NDIS_STATUS     ndisStatus;
    //PVOID           pSysVa;
