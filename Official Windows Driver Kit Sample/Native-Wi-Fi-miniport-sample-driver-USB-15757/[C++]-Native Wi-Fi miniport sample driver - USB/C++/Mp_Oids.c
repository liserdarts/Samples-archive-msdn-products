    ...
    )
{
    ...
    MpTrace(COMP_OID, DBG_LOUD,  ("****  DOT11 RESET _In_ PROGRESS ****\n"));
...
MpSetMulticastList(
    ...
    _Inout_ PULONG puBytesRead,
    _Inout_ PULONG puBytesNeeded
    )
/*++
...
MpQueryPMKIDList(
    _In_ PADAPTER pAdapter,
    _Out_writes_bytes_(InformationBufferLength) PVOID  InformationBuffer,
    _In_ _In_range_(sizeof(DOT11_PMKID_LIST) - sizeof(DOT11_PMKID_ENTRY), 0x7FFFFFFF) ULONG InformationBufferLength,
    _Out_ PULONG                  BytesWritten,
    _Out_ PULONG                  BytesNeeded
    )
{
