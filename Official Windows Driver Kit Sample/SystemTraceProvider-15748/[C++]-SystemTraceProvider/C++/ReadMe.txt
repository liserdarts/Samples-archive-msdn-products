...
================================================
     1. Open Windows Explorer and navigate to the  SystemTraceControl directory.
...
=================
     ...
     2. Type SystemTraceControl.exe at the command line, or double-click the icon for SystemTraceControl.exe to launch it from Windows Explorer.