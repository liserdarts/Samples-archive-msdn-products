<%@ Page Title="Home Page" Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true"
	CodeBehind="Default.aspx.vb" Inherits="AddressBookWebRole._Default" %>
					...
					<asp:Repeater ID="ButtonRepeater" runat="server" OnItemCommand="ClickFilter">
						<ItemTemplate>
							&nbsp;<asp:Button ID="Button1" runat="server" Text='<%#Container.DataItem%>' 
								Width="38" BorderWidth='<%#If((If(Me.ViewState("filter"), "")).ToString() = Container.DataItem.ToString(), 2, 1)%>' 
