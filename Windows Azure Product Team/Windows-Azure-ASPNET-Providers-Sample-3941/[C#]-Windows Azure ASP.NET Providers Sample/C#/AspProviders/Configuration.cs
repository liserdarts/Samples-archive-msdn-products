...
namespace Microsoft.Samples.ServiceHosting.AspProviders
{
    ...
    internal static class Configuration
    {
        ...
        internal static CloudStorageAccount GetStorageAccount(string settingName)
        {
            ...
            catch (InvalidOperationException)
            {
                CloudStorageAccount.SetConfigurationSettingPublisher((configName, configSetter) =>
                {
                    ...
                    string cscvalue = TryGetConfigurationSetting(configName);
                    if (!string.IsNullOrEmpty(cscvalue))
                    {
                        value = cscvalue;
                    }
        ...
        /// .cscfg files (i.e., the settings are read from the Azure configuration system).
        /// </summary>
        internal static string GetConfigurationSetting(string configurationString, string defaultValue, bool throwIfNull = false)
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands", Justification = "CA2122 conflicts with CA2135."), SecuritySafeCritical]
