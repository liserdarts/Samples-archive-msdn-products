        ...
        public override void SetPropertyValues(SettingsContext context, SettingsPropertyValueCollection collection)
        {
            ...
            try
            {
                ...
                using (StreamWriter writer = new StreamWriter(stream))
                {
                    ...
                    _blobProvider.UploadStream(blobName, writer.BaseStream);

                    CreateOrUpdateUserAndProfile(username, authenticated, DateTime.UtcNow, blobName, (int)(writer.BaseStream as MemoryStream).Length);
                }
            }
            catch (Exception e)
            {
