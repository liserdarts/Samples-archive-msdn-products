...
namespace Microsoft.ServiceBus.AccessControlExtensions
{
    ...
    public static class ManagementServiceExtensions
    {
        ...
        public static RelyingParty CreateRelyingParty(this ManagementService svc, string name, string realm, string reply, RelyingPartyTokenType tokenType,
                                                      bool requireEncryption)
        {
            ...
            //
            RelyingPartyAddress realmAddress = new RelyingPartyAddress {Address = realm, EndpointType = RelyingPartyAddressType.Realm.ToString(),};
            ...
            if (!string.IsNullOrEmpty(reply))
            {
                ...
                //
                RelyingPartyAddress replyAddress = new RelyingPartyAddress {Address = reply, EndpointType = RelyingPartyAddressType.Reply.ToString(),};
        ...
        public static void DeleteRelyingPartyByRealmIfExists(this ManagementService svc, string realm)
        {
            ...
            RelyingPartyAddress rpAddress =
                svc.RelyingPartyAddresses.Expand("RelyingParty").Where(
                    addr => addr.Address == realm && addr.EndpointType == RelyingPartyAddressType.Realm.ToString()).FirstOrDefault();
        ...
        /// </summary>
        public static ServiceIdentity CreateServiceIdentity(this ManagementService svc, string name, byte[] keyValue, ServiceIdentityKeyType keyType,
                                                            ServiceIdentityKeyUsage keyUsage)
        {
            ServiceIdentity sid = new ServiceIdentity {Name = name};
        ...
        /// <returns></returns>
        public static Rule CreateRule(this ManagementService svc, Issuer issuer, string inputClaimType, string inputClaimValue, string outputClaimType,
                                      string outputClaimValue, RuleGroup ruleGroup, string description)
        {
            Rule rule = new Rule
                            {
