...
<p><span style="font-size:small">This sample develops state machine workflows based on documents in SharePoint document libraries and items in tasks lists.</span></p>
