...
namespace OutlookAddIn2
{
    ...
    internal static class Constants
    {
        ...
        public static readonly string creationTimeDisplayName = "CreationTime";
        public static readonly string lastModificationTimeDisplayName = "LastModificationTime";
        ...
        // References to custom properties by their namespaces, including data type.

        public static readonly string encounterDatePropTag = encounterDatePropRef + "/0x00000040";
        public static readonly string purchaseEstimatePropTag = purchaseEstimatePropRef + "/0x00000006";
        public static readonly string salesRepPropTag = salesRepPropRef + "/0x0000001f";
        public static readonly string salesValuePropTag = salesValuePropRef + "/0x00000005";
        public static readonly string tradeShowPropTag = tradeShowPropRef + "/0x0000000b";
        ...
        static Constants()
        {
            ...
            dataTypes[encounterDatePropRef] = typeof(DateTime);
            dataTypes[purchaseEstimateDisplayName] = typeof(double);
            dataTypes[purchaseEstimatePropRef] = typeof(double);
            dataTypes[salesRepDisplayName] = typeof(string);
            dataTypes[salesRepPropRef] = typeof(string);
            dataTypes[salesValueDisplayName] = typeof(int);
            dataTypes[salesValuePropRef] = typeof(int);
            dataTypes[tradeShowDisplayName] = typeof(bool);
            dataTypes[tradeShowPropRef] = typeof(bool);

            displayNames = new Dictionary<string, string>();
            displayNames[customerIDProperRef] = customerIDDisplayName;
            displayNames[encounterDatePropTag] = encounterDateDisplayName;
            displayNames[purchaseEstimatePropTag] = purchaseEstimateDisplayName;
            displayNames[salesRepPropTag] = salesRepDisplayName;
            displayNames[salesValuePropTag] = salesValueDisplayName;
            displayNames[tradeShowPropTag] = tradeShowDisplayName;
        }

        /// <summary>Returns the managed data type for a given property.</summary>
        /// <param name="fieldName">The property name or a reference to a property
        /// by its property tag.</param>
        ...
        /// <summary>Returns the display name of the custom property that corresponds
        /// to the given property tag.</summary>
        /// <param name="propTag">The property tag or a reference to a property by
        /// its namespace.</param>
        /// <returns>The display name of the property; or the propTag parameter, if
        /// the property tag is not recognized.</returns>
        internal static string GetDisplayName(string propTag)
        {
            if (displayNames.ContainsKey(propTag))
            {
                return displayNames[propTag];
            }
            else
            {
                return propTag;
