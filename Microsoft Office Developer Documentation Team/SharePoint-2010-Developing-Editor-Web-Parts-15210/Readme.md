...
<p><span style="font-size:small">This sample modifies a Web Part properties sheet to include an Editor Web Part that enables users to choose from all the lists in the SharePoint site.</span></p>
