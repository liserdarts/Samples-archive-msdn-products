...
<ul>
<li><span style="font-size:small">The AppOnlyREST project, which contains the AppManifest.xml file.</span>
</li><li><span style="font-size:small">The AppOnlyRESTWeb project, which contains:</span>
<ul>
...
</li><li><span style="font-size:small">The Home.aspx.cs file, which contains the C# code that uses the client object model (CSOM) to read and write data.</span>
...
</li><li><span style="font-size:small">On the consent page, choose Trust It to grant permissions to the app.</span>
</li></ol>
<h1>Example</h1>
...
<p><span style="font-size:small"><img id="60395" src="http://i1.code.msdn.s-msft.com/sharepoint-2013-make-app-28141ce6/image/file/60395/1/fig1sm.gif" alt="" width="650" height="19"></span></p>
...
<p><span style="font-size:small"><img id="60396" src="http://i1.code.msdn.s-msft.com/sharepoint-2013-make-app-28141ce6/image/file/60396/1/fig1.gif" alt="" width="260" height="674"></span></p>
