# Exchange 2013: Delete attachments from Exchange items programmatically
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Delete attachments from Exchange items programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to delete item and file attachments from Exchange items.</p>
</div>
<h1>Description of the Exchange 2013: Delete attachments from Exchange items programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, finds an email that includes attachments, and deletes the attachments in three different ways.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_DeleteAttachments_CS.sln — The Visual Studio 2010 solution file for the Ex15_DeleteAttachments_CS project.</p>
</li><li>
<p>Ex15_DeleteAttachments_CS.csproj — The Visual Studio 2010 project file for the
<b>DeleteAttachments</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_DeleteAttachments_CS project.</p>
</li><li>
<p>Ex15_DeleteAttachments_CS.cs — Contains the using directives, namespace, class, and functions to delete attachments from an item.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_DeleteAttachments_CS project.</p>
</li><li>
...
<p>Follow these steps to configure Exchange 2013: Delete attachments on Exchange items programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_DeleteAttachments_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
