...
namespace PersistentChatLibrarySamples
{
    ...
    internal static class SampleCommon
    {
        ...
        public static string OcsServer = "ocs.contoso.com";
        ...
        public static UserEndpoint ConnectOfficeCommunicationServer(string userSipUri, string ocsServer, bool usingSso, string username, string password)
        {
            // Create the OCS UserEndpoint and attempt to connect to OCS
            Console.WriteLine("Connecting to Lync Server... [{0}]", ocsServer);
