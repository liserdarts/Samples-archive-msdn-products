...
''' </summary>
Friend Class JournalItemWrapper
    Inherits InspectorWrapper

    ''' <summary>
    ''' The Object instance behind the Inspector (CurrentItem)
    ''' </summary>
    Private m_Item As Outlook.JournalItem
    Public Property Item As Outlook.JournalItem
        Get
            Return m_Item
        End Get
        Private Set(ByVal value As Outlook.JournalItem)
            m_Item = value
        End Set
    End Property
    ...
    Protected Overloads Overrides Sub Initialize()
        ...
        Item = DirectCast(Inspector.CurrentItem, Outlook.JournalItem)
