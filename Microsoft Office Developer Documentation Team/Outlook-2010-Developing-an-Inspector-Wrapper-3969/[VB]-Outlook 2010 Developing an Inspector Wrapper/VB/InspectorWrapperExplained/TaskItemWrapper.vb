...
''' </summary>
Friend Class TaskItemWrapper
    Inherits InspectorWrapper

    ''' <summary>
    ''' The Object instance behind the Inspector (CurrentItem)
    ''' </summary>
    Private m_Item As Outlook.TaskItem
    Public Property Item As Outlook.TaskItem
        Get
            Return m_Item
        End Get
        Private Set(ByVal value As Outlook.TaskItem)
            m_Item = value
        End Set
    End Property
    ...
    Protected Overloads Overrides Sub Initialize()
        ...
        Item = DirectCast(Inspector.CurrentItem, Outlook.TaskItem)
