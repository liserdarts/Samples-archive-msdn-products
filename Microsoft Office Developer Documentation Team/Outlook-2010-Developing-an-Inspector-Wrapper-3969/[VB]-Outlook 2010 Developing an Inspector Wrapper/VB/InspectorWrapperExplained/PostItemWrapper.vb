...
''' </summary>
Friend Class PostItemWrapper
    Inherits InspectorWrapper

    ''' <summary>
    ''' The Object instance behind the Inspector (CurrentItem)
    ''' </summary>
    Private m_Item As Outlook.PostItem
    Public Property Item As Outlook.PostItem
        Get
            Return m_Item
        End Get
        Private Set(ByVal value As Outlook.PostItem)
            m_Item = value
        End Set
    End Property
    ...
    Protected Overloads Overrides Sub Initialize()
        ...
        Item = DirectCast(Inspector.CurrentItem, Outlook.PostItem)
