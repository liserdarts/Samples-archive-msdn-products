...
Strings.OfficeOM.L_NoCapability = "No tiene suficiente capacidad para realizar esta acción.";
...
Strings.OfficeOM.L_ShuttingDown = "No se pudo realizar la operación porque los datos del servidor son obsoletos.";
...
Strings.OfficeOM.L_InvalidApiCallInContext = "Llamada de API no válida en el contexto actual.";
...
Strings.OfficeOM.L_SettingsAreStale = "La configuración no se pudo guardar porque es obsoleta.";
...
Strings.OfficeOM.L_DocumentIsTooLarge = "El tamaño del documento es demasiado grande.";
