    ...
    Office._context_document = function () {
        ...
        if (Office._WordMask & Office._appContext) {
            ...
            this.getAllContentAsync = function (fileType, callback) {
                ...
                ///<param name="callback" type="function" optional="true">The optional callback method</param>
                var result = new Office._AsyncResult("getAllContentAsync");
                callback(result);
            };
        ...
        if (Office._ProjectMask & Office._appContext) {
            ...
            Office.ProjectViewTypes = {
                ///<view type="Number">Gantt</field>
                Gantt: 1,
                ///<view type="Number">NetworkDiagram</field>
                NetworkDiagram: 2,
                ///<view type="Number">TaskDiagram</field>
                TaskDiagram: 3,
                ///<view type="Number">TaskForm</field>
                TaskForm: 4,
                ///<view type="Number">TaskSheet</field>
                TaskSheet: 5,
                ///<view type="Number">ResourceForm</field>
                ResourceForm: 6,
                ///<view type="Number">ResourceSheet</field>
                ResourceSheet: 7,
                ///<view type="Number">ResourceGraph</field>
                ResourceGraph: 8,
                ///<view type="Number">TeamPlanner</field>
                TeamPlanner: 9,
                ///<view type="Number">TaskDetails</field>
                TaskDetails: 10,
                ///<view type="Number">TaskNameForm</field>
                TaskNameForm: 11,
                ///<view type="Number">ResourceNames</field>
                ResourceNames: 12,
                ///<view type="Number">Calendar</field>
                Calendar: 13,
                ///<view type="Number">TaskUsage</field>
                TaskUsage: 14,
                ///<view type="Number">ResourceUsage</field>
                ResourceUsage: 15,
                ///<view type="Number">Timeline</field>
                Timeline: 16
