...
<div id="header">This sample shows you how to use the <strong>RoutingAgent</strong> classes to implement a Mailbox server logging transport agent.</div>
<div id="mainSection">
<div id="mainBody">
<h1 class="heading">Description of the Exchange 2013: Build a Mailbox server logging transport agent sample</h1>
<div class="section" id="sectionSection0">
<p>This sample shows how to create an agent that responds to the <strong>RoutingAgent.OnRoutedMessage</strong> transport pipeline event, and synchronously logs the message to a file on the local hard disk.</p>
</div>
...
<p>MailboxServerLogging.csproj &mdash; The Visual Studio C# project file for the agent.</p>
</li><li>
<p>MailboxServerLogging.cs &mdash; The C# source code for the sample.</p>
</li></ul>
</div>
<h1 class="heading">Build the sample</h1>
<div class="section" id="sectionSection3">
<p>Follow these steps to build the Exchange 2013: Build a Mailbox server logging transport agent sample.</p>
<ol>
<li>
<p>Open the MailboxServerLogging.csproj C# project by using Visual Studio.</p>
</li><li>
...
<ol>
<li>
<p>This sample agent will be installed into the C:\TransportAgentSamples\MailboxServerLogging folder. If you want to install it in a different location, edit the install.ps1 script to ensure that the $EXDIR variable is set to the correct folder.</p>
</li><li>
<p>Copy the following files from your client to the folder C:\TransportAgentSamples\Setup\MailboxServerLogging on the Exchange server:</p>
<ul>
<li>
<p>MailboxServerLogging.dll</p>
</li><li>
<p>Install.ps1</p>
</li></ul>
</li><li>
...
<p>Copy the following file from your client to the folder C:\TransportAgentSamples\Setup\MailboxServerLogging on the Exchange server:</p>
<ul>
<li>
<p>Uninstall.ps1</p>
</li></ul>
