# Exchange 2013: Cancel meetings programmatically
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Cancel meetings programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to cancel meetings.</p>
</div>
<h1>Description of the Exchange 2013: Cancel meetings programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, finds a meeting, and then tries to cancel the meeting if the caller is the meeting organizer.</p>
</div>
<h1>Prerequisites</h1>
...
<p>The .NET Framework version 4.0.</p>
</li><li>
...
<p>A meeting with a subject value of &quot;Lunch&quot; that you created.</p>
</li></ul>
</div>
...
<ul>
<li>
<p>Ex15_CancelMeeting_CS.sln — The Visual Studio 2010 solution file for the CancelMeeting project.</p>
</li><li>
<p>Ex15_CancelMeeting_CS.csproj — The Visual Studio 2010 project file for the <b>
CancelMeeting</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15GetRooms project.</p>
</li><li>
<p>Ex15_CancelMeeting_CS.cs — Contains the using directives, namespace, class, and functions to find and cancel a meeting.</p>
</li><li>
...
<b>ExchangeService</b> object used in the CancelMeeting project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Cancel meetings programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_CancelMeeting_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
...
<p>On line 28 in Ex15_CancelMeeting_CS.cs, set the organizer variable to the email address of the person making the call.</p>
</li></ol>
<p></p>
</div>
...
<p><a href="http://code.msdn.microsoft.com/Exchange-2013-Create-cae5359a" target="_blank">Exchange 2013: Create appointments programmatically</a>
</p>
</li><li>
