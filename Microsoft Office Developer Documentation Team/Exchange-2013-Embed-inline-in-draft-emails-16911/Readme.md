# Exchange 2013: Embed inline images in draft emails programmatically
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Embed inline images in draft email messages programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to embed inline images in an email message.</p>
</div>
<h1>Description of the Exchange 2013: Embed inline images in draft email messages programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, and then adds an inline image to an email message.
</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_EmbedInlineImageInEmail_CS.sln — The Visual Studio 2010 solution file for the Ex15_EmbedInlineImageInEmail_CS project.</p>
</li><li>
<p>Ex15_EmbedInlineImageInEmail_CS.csproj — The Visual Studio 2010 project file for the
<b>EmbedInlineImageInEmail</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_EmbedInlineImageInEmail_CS project.</p>
</li><li>
<p>Ex15_EmbedInlineImageInEmail_CS.cs — Contains the using statements, namespace, class, and functions to embed an inline image in an email message.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_EmbedInlineImageInEmail_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Embed inline images in draft email messages programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_EmbedInlineImageInEmail_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
<b><span class="ui">Project</span></b> menu.</p>
</li><li>
<p>Update the recipient to a valid email address in line 29 in Ex15_EmbedInlineImageInEmail_CS.cs.</p>
</li><li>
