...
<p><span style="font-size:small">This sample authenticates an email address and password entered from the console and creates a task in the authenticated user's task folder.</span></p>
<h1>Prerequisites</h1>
<p><span style="font-size:small">This sample requires the following:</span></p>
<ul>
<li><span style="font-size:small">A target server that is running a version of Exchange starting with Exchange Server 2007 Service Pack 1 (SP1), including Exchange Online.</span>
...
<ul>
<li><span style="font-size:small">Ex15_CreateTask_CS.sln &mdash; The Visual Studio 2010 solution file for the Ex15_CreateTask_CS project.</span>
</li><li><span style="font-size:small">Ex15_CreateTask_CS.csproj &mdash; The Visual Studio 2010 project file for the task save function.</span>
</li><li><span style="font-size:small">app.config &mdash; Contains configuration data for the Ex15_CreateTask_CS project.</span>
</li><li><span style="font-size:small">Ex15_CreateTask_CS.cs &mdash; Contains the using statements, namespace, class, and functions to create a task.</span>
...
</li><li><span style="font-size:small">Service.cs &mdash; Contains the using statements, namespace, class, and functions necessary to acquire an ExchangeService object used in the Ex15_CreateTask_CS project.</span>
...
<p><span style="font-size:small">Follow these steps to configure the Exchange 2013: Create tasks programmatically on Exchange servers sample.</span></p>
<ol>
<li><span style="font-size:small">Set the startup project to Ex15_CreateTask_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the Project menu.</span>
