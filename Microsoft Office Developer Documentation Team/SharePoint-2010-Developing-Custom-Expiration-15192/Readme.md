...
<p><span style="font-size:small">This sample calculates an expiration date for a SharePoint information management policy by using a custom expiration formula.</span></p>
