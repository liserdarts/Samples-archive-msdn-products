# Lync 2013: Start new conversations from a WPF application
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to start a new Lync 2013 conversation from a Windows Presentation Foundation (WPF) application by using Lync conversation WPF controls.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to create a user control by using Lync buttons, assign a button source to a SIP URI, and add the user control to a list box.</p>
<p>This sample, ButtonsDesktop, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ul>
<li>
<p>Open ButtonsDesktop.csproj.</p>
</li><li>
