...
<p><span style="font-size:small">This sample authenticates an email address and password entered from the console and deletes a user configuration object.</span></p>
<h1>Prerequisites</h1>
...
<ul>
<li><span style="font-size:small">Ex15_DeleteUserConfiguration_CS.sln &mdash; The Visual Studio 2010 solution file for the Ex15_DeleteUserConfiguration_CS project.</span>
</li><li><span style="font-size:small">Ex15_DeleteUserConfiguration_CS.csproj &mdash; The Visual Studio 2010 project file for the user configuration delete function.</span>
</li><li><span style="font-size:small">app.config &mdash; Contains configuration data for the Ex15_DeleteUserConfiguration_CS project.</span>
</li><li><span style="font-size:small">Ex15_DeleteUserConfiguration_CS.cs &mdash; Contains the using statements, namespace, class, and functions to delete a user configuration object.</span>
...
<strong>ExchangeService </strong>object used in the Ex15_DeleteUserConfiguration_CS project.</span>
...
<p><span style="font-size:small">Follow these steps to configure the Exchange 2013: Delete user configuration objects programmatically sample.</span></p>
<ol>
<li><span style="font-size:small">Set the startup project to Ex15_DeleteUserConfiguration_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the Project menu.</span>
