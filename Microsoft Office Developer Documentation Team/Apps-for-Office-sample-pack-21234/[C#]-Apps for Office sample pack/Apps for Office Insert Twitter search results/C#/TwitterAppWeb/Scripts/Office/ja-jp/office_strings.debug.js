...
Strings.OfficeOM.L_ShuttingDown = "サーバー上のデータが古いため、操作は失敗しました。";
...
Strings.OfficeOM.L_NonUniformPartialSetNotSupported = "テーブルに結合されたセルが含まれている場合、強制型変換タイプのテーブルで座標パラメーターを使用することはできません。";
...
Strings.OfficeOM.L_SettingsAreStale = "設定が古いため、保存できませんでした。";
...
Strings.OfficeOM.L_DataStale = "古いデータ";
...
Strings.OfficeOM.L_DocumentIsTooLarge = "ドキュメントのサイズが大きすぎます。";
...
Strings.OfficeOM.L_CustomXmlNodeNotFound = "指定したノードは見つかりませんでした。";
