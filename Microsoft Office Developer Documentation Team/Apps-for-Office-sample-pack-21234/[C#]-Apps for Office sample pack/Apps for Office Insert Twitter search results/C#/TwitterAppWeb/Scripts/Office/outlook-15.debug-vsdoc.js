...
Office._$MailboxAppointment = function () {
    ...
    ///<field name="optionalAttendees" type='Array'>Gets a list of email addresses for optional attendees.</field>
    ...
    ///<field name="requiredAttendees" type='Array'>Gets a list of email addresses for required attendees.</field>
    ///<field name="resources" type='Array'>Gets the resources required for an appointment.</field>
    ...
    this.getEntitiesByType = function (entityType) {
        ...
        ///<param name="entityType" type="OfficeEnum.EntityType">One of the EntityType enumeration values.</param>
        if (entityType == Office.OutlookEnums.EntityType.Address) {
            return (new Array(""));
        }

        if (entityType == Office.OutlookEnums.EntityType.Contact) {
            return (new Array(new Office._context_mailbox_item_contact()));
        }

        if (entityType == Office.OutlookEnums.EntityType.EmailAddress) {
            return (new Array(""));
        }

        if (entityType == Office.OutlookEnums.EntityType.MeetingSuggestion) {
            return (new Array(new Office._context_mailbox_item_meetingSuggestion()));
        }

        if (entityType == Office.OutlookEnums.EntityType.PhoneNumber) {
            return (new Array(new Office._context_mailbox_item_phoneNumber()));
        }

        if (entityType == Office.OutlookEnums.EntityType.TaskSuggestion) {
            return (new Array(new Office._context_mailbox_item_taskSuggestion()));
        }

        if (entityType == Office.OutlookEnums.EntityType.Url) {
            return (new Array(""));
        }
    };
...
Office._context_mailbox_item_contact = function () {
    ///<field name="addresses" type='Array'>Gets the mailing and street addresses associated with a contact.</field>
    ///<field name="businessName" type='String'>Gets the name of the business associated with a contact.</field>
    ///<field name="emailAddresses" type='Array'>Gets the SMTP email addresses associated with a contact.</field>
    ///<field name="personName" type='String'>Gets the name of the person associated with a contact.</field>
    ///<field name="phoneNumbers" type='Array'>Gets the phone numbers associated with a contact.</field>
    ///<field name="urls" type='Array'>Get the list of Internet URLs associated with a contact.</field>
...
Office._context_mailbox_item_emailAddressDetails = function () {
    ///<field name="addressType" type="AddressType">Gets the type of address represented by the email address.</field>
    this.addressType = {};
...
Office._context_mailbox_item = function () {
    ///<field name="cc" type='Object'>(Message Item) Gets the carbon-copy (Cc) recipients of a message.</field>
    ...
    ///<field name="from" type='Object'>(Message Item) Gets the email address of the sender of a message.</field>
    ...
    ///<field name="optionalAttendees" type='Array'>(Appointment Item) Gets a list of email addresses for optional attendees.</field>
    ...
    ///<field name="sender" type='Object'>(Message and Appointment) Gets the email address of the sender of an email message.</field>
    ///<field name="requiredAttendees" type='Array'>(Appointment Item) Gets a list of email addresses for required attendees.</field>
    ///<field name="resources" type='Array'>(Appointment Item) Gets the resources required for an appointment.</field>
    ...
    ///<field name="to" type='Array'>(Message Item) Gets the list of recipients of an email message.</field>
    ...
    this.getEntitiesByType = function (entityType) {
        ...
        ///<param name="entityType" type="OutlookEnums.EntityType">One of the EntityType enumeration values.</param>
        if (entityType == Office.OutlookEnums.EntityType.Address) {
            return (new Array(""));
        }
...
Office._context_mailbox_item_meetingRequest = function () {
    ...
    ///<field name="optionalAttendees" type='Array'>Gets a list of the optional attendees for the meeting.</field>
    ///<field name="requiredAttendees" type='Array'>Gets the required attendees for the meeting.</field>
...
Office._context_mailbox_item_meetingSuggestion = function () {
    ///<field name="attendees" type='Array'>Gets the attendees for a suggested meeting.</field>
...
Office._$MailboxMessage = function () {
    ///<field name="cc" type='Object'>Gets the carbon-copy (Cc) recipients of a message.</field>
    ...
    ///<field name="from" type='Object'>Gets the email address of the sender of a message.</field>
    ///<field name="internetMessageId" type='Object'>Gets the Internet message identifier for an email message.</field>
    ///<field name="normalizedSubject" type='Object'>Gets the subject of the item, with standard prefixes removed.</field>
    ///<field name="sender" type='Object'>Gets the email address of the sender of an email message.</field>
    ///<field name="subject" type='Object'>Gets the subject of the item.</field>
    ///<field name="to" type='Array'>Gets the list of recipients of an email message.</field>
    ///<field name="itemId" type="String">Gets the Exchange Web Services (EWS) item identifier for an item.</field>
    ///<field name="itemType" type='Object'>Gets the type of item that an instance represents.</field>
    ///<field name="itemClass" type='Object'>Gets the item class of an item.</field>
...
Office._context_mailbox_item_taskSuggestion = function () {
    ///<field name="assignees" type='Array'>Gets the users that should be assigned a suggested task.</field>
    ///<field name="taskString" type='String'>Gets the text of an item that was identified as a task suggestion.</field>
    this.assignees = new Array(new Office._context_mailbox_item_emailUser());
    this.taskString = {};
};
