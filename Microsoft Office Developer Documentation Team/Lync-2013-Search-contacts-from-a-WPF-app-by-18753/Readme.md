# Lync 2013: Search contacts from a WPF app by adding a ContactSearch control
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to add Lync 2013 contact search capability to a Windows Presentation Foundation (WPF) application by adding a single Lync ContactSearch control to the application.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to create a Lync contact search control, and how to switch between search types (Skill and Name).</p>
<p>This sample, ContactSearchDesktop, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open ContactSearchDesktop.csproj.</p>
</li><li>
