...
<div id="header">Summary: Use this code sample to learn how to display the presence of a set of Lync 2013 users in a list by filling a list with Lync PresenceIndicator controls that can be used to see the presence of the user and start a conversation.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample, PresenceIndicatorDesktop, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open PresenceIndicatorDesktop.csproj.</p>
</li><li>
