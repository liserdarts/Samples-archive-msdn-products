...
<div id="header">Summary: Use this code sample to learn how to start and manage a Lync 2013 meet-now meeting.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to start a Lync 2013 meet-now meeting, manage the meeting lobby of a meet-now meeting, post meeting coordinates in a Persistent Chat room, and pin and lock a participant video.</p>
<p>This sample, MeetingAccess, is built by using the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
