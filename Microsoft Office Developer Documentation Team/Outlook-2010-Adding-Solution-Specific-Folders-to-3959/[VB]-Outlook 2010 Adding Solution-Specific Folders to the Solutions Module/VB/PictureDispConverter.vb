...
Public Class PictureDispConverter
  'IPictureDisp guid
  Public Shared iPictureDispGuid As Guid = GetType(stdole.IPictureDisp).GUID

  'Converts an Icon into a IPictureDisp
  Public Shared Function ToIPictureDisp(ByVal ico As Icon) As stdole.IPictureDisp
  ...
  Public Shared Function ToIPictureDisp(ByVal picture As Image) As stdole.IPictureDisp
  ...
  Private Shared Function OleCreatePictureIndirect(<MarshalAs(UnmanagedType.AsAny)> ByVal picdesc As Object, ByRef iid As Guid, ByVal fOwn As Boolean) As stdole.IPictureDisp
  End Function
