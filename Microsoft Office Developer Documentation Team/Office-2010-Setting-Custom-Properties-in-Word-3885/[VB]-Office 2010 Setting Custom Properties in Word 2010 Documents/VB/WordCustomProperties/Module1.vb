...
Module Module1
  ...
  Sub Main()
    ...
    Console.WriteLine("Manager = " &
                      WDSetCustomProperty(fileName, "Manager", "Peter", PropertyTypes.Text))
    Console.WriteLine("Manager = " &
                      WDSetCustomProperty(fileName, "Manager", "Mary", PropertyTypes.Text))
  ...
  Public Function WDSetCustomProperty( _
    ...
    ByVal propertyValue As Object, ByVal propertyType As PropertyTypes) As String
