# Exchange 2013: Create Inbox rules programmatically on Exchange servers
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Create Inbox rules programmatically on Exchange servers</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to create a server-side Inbox rule for an Exchange mailbox.</p>
</div>
<h1>Description of the Exchange 2013: Create Inbox rules programmatically on Exchange servers sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, and then creates a server-side Inbox rule in the user's mailbox.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_CreateInboxRule_CS.sln — The Visual Studio 2010 solution file for the Ex15_CreateInboxRule_CS project.</p>
</li><li>
<p>Ex15_CreateInboxRule_CS.csproj — The Visual Studio 2010 project file for the <b>
CreateInboxRule</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_CreateInboxRule_CS project.</p>
</li><li>
<p>Ex15_CreateInboxRule_CS.cs — Contains the using directives, namespace, class, and functions to create an Inbox rule.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_CreateInboxRule_CS project.</p>
</li><li>
...
<p>Follow these steps to configure Exchange 2013: Create Inbox rules programmatically on Exchange servers sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_CreateInboxRule_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
