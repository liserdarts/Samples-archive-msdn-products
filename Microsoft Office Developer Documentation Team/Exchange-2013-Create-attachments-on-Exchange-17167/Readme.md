# Exchange 2013: Create attachments on Exchange items programmatically
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Create attachments on Exchange items programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to create item and file attachments on items.</p>
</div>
<h1>Description of the Exchange 2013: Create attachments on Exchange items programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, creates an email message, prompts the user to select a file attachment, attaches the file attachment to the email message in three different ways, finds an email message to
 use as an item attachment, and then adds the item attachment to an email message.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_CreateAttachments_CS.sln — The Visual Studio 2010 solution file for the Ex15_CreateAttachments_CS project.</p>
</li><li>
<p>Ex15_CreateAttachments_CS.csproj — The Visual Studio 2010 project file for the
<b>CreateAttachments</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_CreateAttachments_CS project.</p>
</li><li>
<p>Ex15_CreateAttachments_CS.cs — Contains the using directives, namespace, class, and functions to add attachments to an item.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_CreateAttachments_CS project.</p>
</li><li>
...
<p>Follow these steps to configure Exchange 2013: Create attachments on Exchange items programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_CreateAttachments_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
<b><span class="ui">Project</span></b> menu.</p>
</li><li>
<p>On line 32 of Ex15_CreateAttachments_CS.cs, change the email address to your email address.</p>
</li><li>
...
<p><a href="http://code.msdn.microsoft.com/Exchange-2013-Get-d16d35bf" target="_blank">Exchange 2013: Get attachments on Exchange items programmatically</a>
</p>
</li><li>
