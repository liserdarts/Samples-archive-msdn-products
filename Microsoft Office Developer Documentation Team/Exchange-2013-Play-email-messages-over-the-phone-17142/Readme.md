# Exchange 2013: Play email messages over the phone
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Play email messages over the phone</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to play an email message on the phone.</p>
</div>
<h1>Description of the Exchange 2013: Play email messages on the phone sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, finds an email message in the user's Inbox, and then initiates a phone call that will play the contents of the email message on the phone.</p>
</div>
<h1>Prerequisites</h1>
...
<p>A user account that is enabled for Unified Messaging.</p>
</li><li>
...
<ul>
<li>
<p>Ex15_PlayEmailOnPhone_CS.sln — The Visual Studio 2010 solution file for the Ex15_PlayEmailOnPhone_CS project.</p>
</li><li>
<p>Ex15_PlayEmailOnPhone_CS.csproj — The Visual Studio 2010 project file for the <b>
PlayEmailOnPhone</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_PlayEmailOnPhone_CS project.</p>
</li><li>
<p>Ex15_PlayEmailOnPhone_CS.cs — Contains the using statements, namespace, class, and functions to dictate an email over the phone.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_PlayEmailOnPhone_CS project.</p>
</li><li>
...
<p>Follow these steps to configure Exchange 2013: Play email messages on the phone sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_PlayEmailOnPhone_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
<b><span class="ui">Project</span></b> menu.</p>
</li><li>
<p>On line 37 in Ex15_PlayEmailOnPhone_CS.cs file, update the dial string to a valid phone number.</p>
</li><li>
...
<p><a href="http://blogs.msdn.com/b/exchangedev/archive/2009/11/05/play-exchange-2010-mailbox-items-on-your-phone-by-using-the-ews-managed-api.aspx" target="_blank">Play Exchange 2010 Mailbox Items on Your Phone By Using the EWS Managed API</a>
</p>
</li></ul>
</div>
<h1>Change log</h1>
