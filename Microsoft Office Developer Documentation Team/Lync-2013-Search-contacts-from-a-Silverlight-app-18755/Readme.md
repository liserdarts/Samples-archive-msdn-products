# Lync 2013: Search contacts from a Silverlight app by adding a search input box
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to add Lync 2013 contact search capability to a Silverlight application by adding a Lync 2013 search input box control and a Lync 2013 search result control to the application.</div>
<div id="mainSection">
<div id="mainBody">
...
<ol>
<li>
<p>Open ContactSearchInputBoxAndCustomSearchResultListSilverlight.csproj.</p>
</li><li>
