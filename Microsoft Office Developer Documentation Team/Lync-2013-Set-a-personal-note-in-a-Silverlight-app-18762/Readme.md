# Lync 2013: Set a personal note in a Silverlight app
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to set and get your Lync 2013 personal note in a Silverlight application by using a Lync personal note control.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to create a Lync Notebox control and how to retrieve the note.</p>
<p>This sample, MyNoteboxSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open MyNoteboxSilverlight.csproj.</p>
</li><li>
