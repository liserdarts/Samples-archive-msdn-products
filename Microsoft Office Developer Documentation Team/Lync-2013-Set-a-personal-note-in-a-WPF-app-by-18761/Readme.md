# Lync 2013: Set a personal note in a WPF app by using a personal note control
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to set and get your Lync 2013 personal note in a Windows Presentation Foundation (WPF) application by using a Lync personal note control.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample, MyNoteboxDesktop, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open MyNoteboxDesktop.csproj.</p>
</li><li>
