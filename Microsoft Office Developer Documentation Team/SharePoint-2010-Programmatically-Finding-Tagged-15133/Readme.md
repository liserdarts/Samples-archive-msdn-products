...
<p><span style="font-size:small">This sample locates terms that match input strings and then locates all items tagged with those terms in SharePoint lists.</span></p>
