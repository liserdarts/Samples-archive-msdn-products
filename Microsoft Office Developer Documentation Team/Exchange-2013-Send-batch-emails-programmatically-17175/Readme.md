# Exchange 2013: Send batch emails programmatically on Exchange servers
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Send batch email messages programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to send batch email messages.</p>
</div>
<h1>Description of the Exchange 2013: Send batch email messages programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, calls the Autodiscover service, and then tries to send a batch of email messages.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_SendBatchEmail_CS.sln — The Visual Studio 2010 solution file for the Ex15_SendBatchEmail_CS project.</p>
</li><li>
<p>Ex15_SendBatchEmail_CS.csproj — The Visual Studio 2010 project file for the <b>
SendBatchEmails</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_SendBatchEmail_CS project.</p>
</li><li>
<p>Ex15_SendBatchEmail_CS.cs — Contains the using statements, namespace, class, and functions to send batch email messages from a user's mailbox.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_SendBatchEmail_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Send batch email messages programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_SendBatchEmail_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
...
<p>In Ex15_SendBatchEmail_CS.cs, change the email addresses on lines 29, 30, 35, and 41 to valid email addresses.</p>
</li></ol>
<p></p>
</div>
