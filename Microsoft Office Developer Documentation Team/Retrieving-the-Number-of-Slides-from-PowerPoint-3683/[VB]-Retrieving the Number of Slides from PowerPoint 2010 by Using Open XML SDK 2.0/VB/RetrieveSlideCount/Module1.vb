...
Module Module1
  ...
  Private Const DEMOPATH As String = "I:\Samples\HiddenSlides.pptx"

  Sub Main()
    Console.WriteLine(PPTGetSlideCount(DEMOPATH, False))
  End Sub

  Public Function PPTGetSlideCount(ByVal fileName As String, Optional ByVal includeHidden As Boolean = True) As Integer
