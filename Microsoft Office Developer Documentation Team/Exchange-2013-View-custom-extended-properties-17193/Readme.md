...
<td align="left"><span id="nsrTitle">Exchange 2013: View custom extended properties programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to access a custom extended property.</p>
</div>
<h1>Description of the Exchange 2013: View custom extended properties programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, finds an item with the target extended property, and then accesses the extended property on the item.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_ViewCustomExtendedProperties_CS.sln — The Visual Studio 2010 solution file for the Ex15_ViewCustomExtendedProperties_CS project.</p>
</li><li>
<p>Ex15_ViewCustomExtendedProperties_CS.csproj — The Visual Studio 2010 project file for the
<b>ViewCustomExtendedProperties</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_ViewCustomExtendedProperties_CS project.</p>
</li><li>
<p>Ex15_ViewCustomExtendedProperties_CS.cs — Contains the using directives, namespace, class, and functions to access an extended property on an item.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_ViewCustomExtendedProperties_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: View custom extended properties programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_ViewCustomExtendedProperties_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
