# Lync 2013: Set presence indicator and view current activity in a Silverlight app
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to set your Lync 2013 presence and also view your current activity in a Silverlight application by using a Lync PresenceChooser control.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to create a Lync My Presense Chooser control and retrieve the presence.</p>
<p>This sample, MyPresenceChooserSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open MyPresenceChooserSilverlight.csproj.</p>
</li><li>
