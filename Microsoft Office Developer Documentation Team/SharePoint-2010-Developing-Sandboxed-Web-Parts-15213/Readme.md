...
<p><span style="font-size:small">This sample creates a Web Part in a sandboxed solution, and includes Panels to hide controls, radio buttons, and the Render method.</span></p>
