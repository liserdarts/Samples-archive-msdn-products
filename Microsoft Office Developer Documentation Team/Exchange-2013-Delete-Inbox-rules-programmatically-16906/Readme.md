# Exchange 2013: Delete Inbox rules programmatically from Exchange servers
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Delete Inbox rules programmatically from Exchange servers</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to delete server-side Inbox rules from Exchange mailboxes.</p>
</div>
<h1>Description of the Exchange 2013: Delete Inbox rules programmatically from Exchange servers sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, gets all the user's Inbox rules from their mailbox, and then deletes an Inbox rule.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_DeleteInboxRule_CS.sln — The Visual Studio 2010 solution file for the Ex15_DeleteInboxRule_CS project.</p>
</li><li>
<p>Ex15_DeleteInboxRule_CS.csproj — The Visual Studio 2010 project file for the <b>
DeleteInboxRule</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_DeleteInboxRule_CS project.</p>
</li><li>
<p>Ex15_DeleteInboxRule_CS.cs — Contains the using directives, namespace, class, and functions to get and delete an Inbox rule from a mailbox.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_DeleteInboxRule_CS project.</p>
</li><li>
...
<p>Follow these steps to configure Exchange 2013: Delete Inbox rules programmatically from Exchange servers sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_DeleteInboxRule_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
...
<p><a href="http://code.msdn.microsoft.com/Exchange-2013-Update-Inbox-4b35ddfc" target="_blank">Exchange 2013: Update Inbox rules programmatically on Exchange servers</a>
</p>
</li></ul>
</div>
<h1>Change log</h1>
