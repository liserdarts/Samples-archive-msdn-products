...
namespace O365_Win8App.Data
{
    ...
    public class SharePointOnlineLoginHelper
    {
        ...
        static SharePointOnlineLoginHelper authobj;
        #endregion

        #region Properties
        public static SharePointOnlineLoginHelper AuthObj
        {
            get
            {
                return authobj;
        ...
        public SharePointOnlineLoginHelper(Uri sharepointSiteUrl, string loginUserName, string loginPassword)
        {
        ...
        public SharePointOnlineLoginHelper(Uri siteurl, string username, string password, string libraryname)
        {
        ...
        {
            var spauthobj = new SharePointOnlineLoginHelper(spSiteUrl, username, password, libraryname);
            var authobjcookie = new SharePointOnlineLoginHelper(spSiteUrl, username, password);
            authobj = spauthobj;
