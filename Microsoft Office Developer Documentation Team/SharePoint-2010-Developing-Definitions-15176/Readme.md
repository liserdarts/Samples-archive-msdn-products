...
<p><span style="font-size:small">This sample creates a custom SharePoint site definition that specifies Content Editor and Image Viewer Web Parts on a Web Part page.</span></p>
