# Exchange 2013: Synchronize a mailbox programmatically
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Synchronize a mailbox programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to keep a server and local client in synch.</p>
</div>
<h1>Description of the Exchange 2013: Synchronize a mailbox programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, retrieves a collection of changes to the Inbox from the server, and displays the changes.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_SyncMailboxes_CS.sln — The Visual Studio 2010 solution file for the Ex15_SyncMailboxes_CS project.</p>
</li><li>
<p>Ex15_SyncMailboxes_CS.csproj — The Visual Studio 2010 project file for the <b>
SyncMailboxes</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_SyncMailboxes_CS project.</p>
</li><li>
<p>Ex15_SyncMailboxes_CS.cs — Contains the using statements, namespace, class, and functions to retrieve synchronization information from a server.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_SyncMailboxes_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Synchronize a mailbox programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_SyncMailboxes_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
