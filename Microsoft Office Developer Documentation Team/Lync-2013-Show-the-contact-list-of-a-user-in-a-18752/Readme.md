...
<div id="header">Summary: Use this code sample to learn how to add a Lync ContactList Silverlight control to a Silverlight application.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to how to create a Lync contact list control, and how to retrieve the URI of the selected contact.</p>
<p>This sample, ContactListSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open ContactListSilverlight.csproj.</p>
</li><li>
