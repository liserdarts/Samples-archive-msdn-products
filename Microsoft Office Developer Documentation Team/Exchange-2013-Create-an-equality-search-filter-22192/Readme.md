# Exchange 2013: Create an equality search filter
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Create an equality search filter</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to create an equality search filter.</p>
</div>
<h1>Description of the Exchange 2013: Create an equality search filter sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, creates an equality search filter, and then makes a call to EWS to find items that match the search filter criteria.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_UseAnEqualitySearchFilter_CS.sln — The Visual Studio 2010 solution file for the Ex15_UseAnEqualitySearchFilter_CS project.</p>
</li><li>
<p>Ex15_UseAnEqualitySearchFilter_CS.csproj — The Visual Studio 2010 project file for the
<b>UseAnEqualitySearchFilter</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_UseAnEqualitySearchFilter_CS project.</p>
</li><li>
<p>Ex15_UseAnEqualitySearchFilter_CS.cs — Contains the using directives, namespace, class, and functions to create an equality search filter and use it in a request to find items in a mailbox.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_UseAnEqualitySearchFilter_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Create an equality search filter sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_UseAnEqualitySearchFilter_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
