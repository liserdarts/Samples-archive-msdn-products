# Lync 2013: Search contacts from a WPF app by adding a search input box control
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to add Lync 2013 contact search capability to a Windows Presentation Foundation (WPF) application by adding a Lync search input box control and a Lync search result control to a WPF application.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to bind a contact search result list to a contact search input box.</p>
<p>This sample is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open ContactSearchInputBoxAndContactSearchResultListDesktop.csproj.</p>
</li><li>
