...
public partial class EntitiesDataContext : Microsoft.SharePoint.Linq.DataContext {
	...
	public Microsoft.SharePoint.Linq.EntityList<InterviewsItem> Interviews {
		get {
			return this.GetList<InterviewsItem>("Interviews");
		}
	}
...
[Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type=typeof(InterviewsItem))]
...
public partial class CandidatesItem : Item {
	...
	private Microsoft.SharePoint.Linq.EntitySet<InterviewsItem> _interviewsItem;
	...
	public CandidatesItem() {
		this._interviewsItem = new Microsoft.SharePoint.Linq.EntitySet<InterviewsItem>();
		this._interviewsItem.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<InterviewsItem>>(this.OnInterviewsItemSync);
		this._interviewsItem.OnChanged += new System.EventHandler(this.OnInterviewsItemChanged);
		this._interviewsItem.OnChanging += new System.EventHandler(this.OnInterviewsItemChanging);
		this.OnCreated();
	}
	
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Name", Storage="_name", FieldType="Text")]
	public string Name {
		get {
			return this._name;
		}
	...
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Candidate", Storage="_interviewsItem", ReadOnly=true, MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Backward, List="Interviews")]
	public Microsoft.SharePoint.Linq.EntitySet<InterviewsItem> InterviewsItem {
		get {
			return this._interviewsItem;
		}
		set {
			this._interviewsItem.Assign(value);
		}
	}
	
	private void OnInterviewsItemChanging(object sender, System.EventArgs e) {
		this.OnPropertyChanging("InterviewsItem", this._interviewsItem.Clone());
	}
	
	private void OnInterviewsItemChanged(object sender, System.EventArgs e) {
		this.OnPropertyChanged("InterviewsItem");
	}
	
	private void OnInterviewsItemSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<InterviewsItem> e) {
		if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
			e.Item.Candidate = this;
		}
		else {
			e.Item.Candidate = null;
		}
	}
}
...
/// Create a new list item.
/// </summary>
[Microsoft.SharePoint.Linq.ContentTypeAttribute(Name="Item", Id="0x01", List="Interviews")]
public partial class InterviewsItem : Item {
	
	private System.Nullable<System.DateTime> _date;
	
	private System.Nullable<Outcome> _outcome;
	
	private Microsoft.SharePoint.Linq.EntityRef<CandidatesItem> _candidate;
	...
	public InterviewsItem() {
		this._candidate = new Microsoft.SharePoint.Linq.EntityRef<CandidatesItem>();
		this._candidate.OnSync += new System.EventHandler<Microsoft.SharePoint.Linq.AssociationChangedEventArgs<CandidatesItem>>(this.OnCandidateSync);
		this._candidate.OnChanged += new System.EventHandler(this.OnCandidateChanged);
		this._candidate.OnChanging += new System.EventHandler(this.OnCandidateChanging);
		this.OnCreated();
	}
	
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Date", Storage="_date", FieldType="DateTime")]
	...
	[Microsoft.SharePoint.Linq.ColumnAttribute(Name="Outcome", Storage="_outcome", FieldType="Choice")]
	public System.Nullable<Outcome> Outcome {
		get {
	...
	[Microsoft.SharePoint.Linq.AssociationAttribute(Name="Candidate", Storage="_candidate", MultivalueType=Microsoft.SharePoint.Linq.AssociationType.Single, List="Candidates")]
	public CandidatesItem Candidate {
		get {
			return this._candidate.GetEntity();
		}
		set {
			this._candidate.SetEntity(value);
		}
	}
	...
	private void OnCandidateChanging(object sender, System.EventArgs e) {
		this.OnPropertyChanging("Candidate", this._candidate.Clone());
	}
	
	private void OnCandidateChanged(object sender, System.EventArgs e) {
		this.OnPropertyChanged("Candidate");
	}
	
	private void OnCandidateSync(object sender, Microsoft.SharePoint.Linq.AssociationChangedEventArgs<CandidatesItem> e) {
		if ((Microsoft.SharePoint.Linq.AssociationChangedState.Added == e.State)) {
			e.Item.InterviewsItem.Add(this);
		}
		else {
			e.Item.InterviewsItem.Remove(this);
		}
	}
}
...
public enum Outcome : int {
	...
	[Microsoft.SharePoint.Linq.ChoiceAttribute(Value="Offered")]
	Offered = 8,
}
