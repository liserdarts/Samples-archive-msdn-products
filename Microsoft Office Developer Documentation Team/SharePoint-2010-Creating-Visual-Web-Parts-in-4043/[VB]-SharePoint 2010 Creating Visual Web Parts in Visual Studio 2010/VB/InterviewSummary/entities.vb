...
Partial Public Class EntitiesDataContext
	...
	<Microsoft.SharePoint.Linq.ListAttribute(Name:="Candidates")>  _
	Public ReadOnly Property Candidates() As Microsoft.SharePoint.Linq.EntityList(Of CandidatesItem)
		Get
			Return Me.GetList(Of CandidatesItem)("Candidates")
		End Get
	End Property
	...
	<Microsoft.SharePoint.Linq.ListAttribute(Name:="Interviews")>  _
	Public ReadOnly Property Interviews() As Microsoft.SharePoint.Linq.EntityList(Of InterviewsItem)
		Get
			Return Me.GetList(Of InterviewsItem)("Interviews")
		End Get
	End Property
	...
	Public ReadOnly Property SiteCollectionImages() As Microsoft.SharePoint.Linq.EntityList(Of RichMediaAsset)
		Get
			Return Me.GetList(Of RichMediaAsset)("Site Collection Images")
		End Get
	End Property
...
<Microsoft.SharePoint.Linq.ContentTypeAttribute(Name:="Item", Id:="0x01"),  _
 ...
 Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type:=GetType(CandidatesItem)),  _
 ...
 Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type:=GetType(InterviewsItem)),  _
...
<Microsoft.SharePoint.Linq.ContentTypeAttribute(Name:="Document", Id:="0x0101"),  _
 Microsoft.SharePoint.Linq.DerivedEntityClassAttribute(Type:=GetType(RichMediaAsset)),  _
...
'''Create a new list item.
'''</summary>
<Microsoft.SharePoint.Linq.ContentTypeAttribute(Name:="Item", Id:="0x01", List:="Candidates")>  _
Partial Public Class CandidatesItem
	Inherits Item
	...
	Private _interviewsItem As Microsoft.SharePoint.Linq.EntitySet(Of InterviewsItem)
	...
	Public Sub New()
		MyBase.New
		Me._interviewsItem = New Microsoft.SharePoint.Linq.EntitySet(Of InterviewsItem)
		AddHandler Me._interviewsItem.OnSync, AddressOf Me.OnInterviewsItemSync
		AddHandler Me._interviewsItem.OnChanged, AddressOf Me.OnInterviewsItemChanged
		AddHandler Me._interviewsItem.OnChanging, AddressOf Me.OnInterviewsItemChanging
		Me.OnCreated
	End Sub
	
	<Microsoft.SharePoint.Linq.ColumnAttribute(Name:="Name", Storage:="_name", FieldType:="Text")>  _
	Public Property Name() As String
		Get
			Return Me._name
		End Get
	...
	<Microsoft.SharePoint.Linq.ColumnAttribute(Name:="HomeCity", Storage:="_homeCity", FieldType:="Text")>  _
	Public Property HomeCity() As String
		Get
			Return Me._homeCity
		End Get
		Set
			If (value <> Me._homeCity) Then
				Me.OnPropertyChanging("HomeCity", Me._homeCity)
				Me._homeCity = value
				Me.OnPropertyChanged("HomeCity")
			End If
		End Set
	End Property
	
	<Microsoft.SharePoint.Linq.AssociationAttribute(Name:="Candidate", Storage:="_interviewsItem", [ReadOnly]:=true, MultivalueType:=Microsoft.SharePoint.Linq.AssociationType.Backward, List:="Interviews")>  _
	Public Property InterviewsItem() As Microsoft.SharePoint.Linq.EntitySet(Of InterviewsItem)
		Get
			Return Me._interviewsItem
		End Get
		Set
			Me._interviewsItem.Assign(value)
		End Set
	End Property
	
	Private Sub OnInterviewsItemChanging(ByVal sender As Object, ByVal e As System.EventArgs)
		Me.OnPropertyChanging("InterviewsItem", Me._interviewsItem.Clone)
	End Sub
	
	Private Sub OnInterviewsItemChanged(ByVal sender As Object, ByVal e As System.EventArgs)
		Me.OnPropertyChanged("InterviewsItem")
	End Sub
	
	Private Sub OnInterviewsItemSync(ByVal sender As Object, ByVal e As Microsoft.SharePoint.Linq.AssociationChangedEventArgs(Of InterviewsItem))
		If (Microsoft.SharePoint.Linq.AssociationChangedState.Added = e.State) Then
			e.Item.Candidate = Me
		Else
			e.Item.Candidate = Nothing
		End If
	End Sub
End Class
...
'''Create a new list item.
'''</summary>
<Microsoft.SharePoint.Linq.ContentTypeAttribute(Name:="Item", Id:="0x01", List:="Interviews")>  _
Partial Public Class InterviewsItem
	Inherits Item
	
	Private _date As System.Nullable(Of Date)
	
	Private _outcome As System.Nullable(Of Outcome)
	
	Private _candidate As Microsoft.SharePoint.Linq.EntityRef(Of CandidatesItem)
	
	Private _interviewerId As System.Nullable(Of Integer)
	
	Private _interviewerImnName As String
	...
	Public Sub New()
		MyBase.New
		Me._candidate = New Microsoft.SharePoint.Linq.EntityRef(Of CandidatesItem)
		AddHandler Me._candidate.OnSync, AddressOf Me.OnCandidateSync
		AddHandler Me._candidate.OnChanged, AddressOf Me.OnCandidateChanged
		AddHandler Me._candidate.OnChanging, AddressOf Me.OnCandidateChanging
		Me.OnCreated
	End Sub
	
	<Microsoft.SharePoint.Linq.ColumnAttribute(Name:="Date", Storage:="_date", FieldType:="DateTime")>  _
	Public Property [Date]() As System.Nullable(Of Date)
		Get
			Return Me._date
		End Get
		Set
			If (value <> Me._date) Then
				Me.OnPropertyChanging("Date", Me._date)
				Me._date = value
	...
	<Microsoft.SharePoint.Linq.ColumnAttribute(Name:="Outcome", Storage:="_outcome", FieldType:="Choice")>  _
	Public Property Outcome() As System.Nullable(Of Outcome)
		Get
			Return Me._outcome
		End Get
		Set
			If (value <> Me._outcome) Then
				Me.OnPropertyChanging("Outcome", Me._outcome)
				Me._outcome = value
				Me.OnPropertyChanged("Outcome")
			End If
		End Set
	End Property
	
	<Microsoft.SharePoint.Linq.AssociationAttribute(Name:="Candidate", Storage:="_candidate", MultivalueType:=Microsoft.SharePoint.Linq.AssociationType.[Single], List:="Candidates")>  _
	Public Property Candidate() As CandidatesItem
		Get
			Return Me._candidate.GetEntity
		End Get
		Set
			Me._candidate.SetEntity(value)
		End Set
	End Property
	
	<Microsoft.SharePoint.Linq.ColumnAttribute(Name:="Interviewer", Storage:="_interviewerId", FieldType:="User", IsLookupId:=true)>  _
	Public Property InterviewerId() As System.Nullable(Of Integer)
		Get
			Return Me._interviewerId
		End Get
		Set
			If (value <> Me._interviewerId) Then
				Me.OnPropertyChanging("InterviewerId", Me._interviewerId)
				Me._interviewerId = value
				Me.OnPropertyChanged("InterviewerId")
			End If
		End Set
	End Property
	
	<Microsoft.SharePoint.Linq.ColumnAttribute(Name:="Interviewer", Storage:="_interviewerImnName", [ReadOnly]:=true, FieldType:="User", IsLookupValue:=true)>  _
	Public Property InterviewerImnName() As String
		Get
			Return Me._interviewerImnName
		End Get
		Set
			If (value <> Me._interviewerImnName) Then
				Me.OnPropertyChanging("InterviewerImnName", Me._interviewerImnName)
				Me._interviewerImnName = value
				Me.OnPropertyChanged("InterviewerImnName")
			End If
		End Set
	End Property
	
	Private Sub OnCandidateChanging(ByVal sender As Object, ByVal e As System.EventArgs)
		Me.OnPropertyChanging("Candidate", Me._candidate.Clone)
	End Sub
	
	Private Sub OnCandidateChanged(ByVal sender As Object, ByVal e As System.EventArgs)
		Me.OnPropertyChanged("Candidate")
	End Sub
	
	Private Sub OnCandidateSync(ByVal sender As Object, ByVal e As Microsoft.SharePoint.Linq.AssociationChangedEventArgs(Of CandidatesItem))
		If (Microsoft.SharePoint.Linq.AssociationChangedState.Added = e.State) Then
			e.Item.InterviewsItem.Add(Me)
		Else
			e.Item.InterviewsItem.Remove(Me)
		End If
	End Sub
End Class
...
'''Upload an asset.
'''</summary>
<Microsoft.SharePoint.Linq.ContentTypeAttribute(Name:="Rich Media Asset", Id:="0x0101009148F5A04DDD49CBA7127AADA5FB792B"),  _
...
Partial Public Class RichMediaAsset
	Inherits Document
...
Public Enum Outcome As Integer
	
	None = 0
	
	Invalid = 1
	
	<Microsoft.SharePoint.Linq.ChoiceAttribute(Value:="Pending")>  _
	Pending = 2
	
	<Microsoft.SharePoint.Linq.ChoiceAttribute(Value:="Rejected")>  _
	Rejected = 4
	
	<Microsoft.SharePoint.Linq.ChoiceAttribute(Value:="Offered")>  _
	Offered = 8
End Enum
