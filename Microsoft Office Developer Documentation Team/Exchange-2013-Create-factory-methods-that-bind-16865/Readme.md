# Exchange 2013: Create factory methods that bind applications to an email account
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Create factory methods that bind applications to email accounts</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to connect to an Exchange server.</p>
</div>
<h1>Description of the Exchange 2013: Create factory methods that bind applications to email accounts sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample uses the default credentials of the logged-on user, gets an email address and password from the command line, and impersonates another account on the server.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_ConnectToServer_CS.sln — The Visual Studio 2010 solution file for the Ex15_ConnectToServer_CS project.</p>
</li><li>
<p>Ex15_ConnectToServer_CS.csproj — The Visual Studio 2010 project file for the <b>
ConnectToServer</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_ConnectToServer_CS project.</p>
</li><li>
<p>Ex15_ConnectToServer_CS.cs — Contains the using directives, namespace, class, and functions to get email and password information from the user by using the
<b>Ex15_CTS_UserData</b> object and call the appropriate function on the <b>Ex15_CTS_Service</b> object.</p>
</li><li>
<p>Ex15_CTS_Service.cs - Creates a new <b>ExchangeService</b> object by using the user's default credentials, credentials that are entered, and impersonation.</p>
</li><li>
<p>Ex15_CTS_UserData.cs - Gets credential information from the user's console.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_ConnectToServer_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Create factory methods that bind applications to email accounts sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_ConnectToServer_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
