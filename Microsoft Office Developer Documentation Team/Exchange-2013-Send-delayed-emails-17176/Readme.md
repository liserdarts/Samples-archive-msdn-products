...
<p><span style="font-size:small">This sample authenticates an email address and password entered from the console, creates an email message, sets properties on the message, and submits the request to send the message. An extended property set on the email message
 specifies the time in the future when the email will be sent.</span></p>
<h1>Prerequisites</h1>
...
<ul>
<li><span style="font-size:small">Ex15_DelaySendEmail_CS.sln &mdash; The Visual Studio 2010 solution file for the Ex15_DelaySendEmail_CS project.</span>
</li><li><span style="font-size:small">Ex15_DelaySendEmail_CS.csproj &mdash; The Visual Studio 2010 project file for the
<strong>DelaySendEmail </strong>function.</span> </li><li><span style="font-size:small">app.config &mdash; Contains configuration data for the Ex15_DelaySendEmail_CS project.</span>
</li><li><span style="font-size:small">Ex15_DelaySendEmail_CS.cs &mdash; Contains the using statements, namespace, class, and functions to create an email and send it at a specified time in the future.</span>
...
<strong>ExchangeService </strong>object used in the Ex15_DelaySendEmail_CS project.</span>
...
<p><span style="font-size:small">Follow these steps to configure the Exchange 2013: Send delayed emails programmatically on Exchange servers sample.</span></p>
<ol>
<li><span style="font-size:small">Set the startup project to Ex15_DelaySendEmail_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the Project menu.</span>
