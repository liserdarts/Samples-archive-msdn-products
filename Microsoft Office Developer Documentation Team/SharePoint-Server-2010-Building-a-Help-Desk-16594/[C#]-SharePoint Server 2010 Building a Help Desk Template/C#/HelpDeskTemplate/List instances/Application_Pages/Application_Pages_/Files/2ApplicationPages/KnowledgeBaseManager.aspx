...
<asp:Content ContentPlaceHolderId="PlaceHolderPageImage" runat="server">
	...
	<img src="/HelpDesk/_layouts/images/blank.gif" width='1' height='1' alt="" /></asp:Content>
		 ...
		 <table width="100%" cellpadding="0" cellspacing="0" style="padding: 5px 10px 10px 10px;">
		  <tr>
		   <td valign="top" width="70%">
               ...
               <tr>
                    <td width="35%">
                        <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="Leftbottom1" Title="loc:Left"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			            &nbsp;
                    </td>
                    <td width="35%">
                        <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="Leftbottom2" Title="loc:Left"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			            &nbsp;
                    </td>
               </tr>
              </table>    
