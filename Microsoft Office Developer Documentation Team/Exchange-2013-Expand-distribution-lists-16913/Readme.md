...
<p><span style="font-size:small">This sample authenticates an email address and password entered from the console, retrieves a set of email addresses that are associated with a distribution list, and displays the email addresses to the console.</span></p>
<h1>Prerequisites</h1>
...
<ul>
<li><span style="font-size:small">Ex15_ExpandDistributionLists_CS.sln &mdash; The Visual Studio 2010 solution file for the Ex15_ExpandDistributionLists_CS project.</span>
</li><li><span style="font-size:small">Ex15_ExpandDistributionLists_CS.csproj &mdash; The Visual Studio 2010 project file for the
<strong>ExpandDistributionLists </strong>function.</span> </li><li><span style="font-size:small">app.config &mdash; Contains configuration data for the Ex15_ ExpandDistributionLists_CS project.</span>
</li><li><span style="font-size:small">Ex15_ExpandDistributionLists_CS.cs &mdash; Contains the using statements, namespace, class, and functions to expand the email addresses in a distribution list.</span>
...
<strong>ExchangeService </strong>object used in the Ex15_ExpandDistributionLists_CS project.</span>
...
<p><span style="font-size:small">Follow these steps to configure the Exchange 2013: Expand distribution lists programmatically on Exchange servers sample.</span></p>
<ol>
<li><span style="font-size:small">Set the startup project to Ex15_ExpandDistributionLists_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the Project menu.</span>
