...
<div id="header">Summary: Use this code sample to learn how to create a custom view of the Lync 2013 contact list in a Windows Presentation Foundation (WPF) application by using two Lync WPF controls.</div>
<div id="mainSection">
<div id="mainBody">
...
<ol>
<li>
<p>Open CustomContactListAndCustomContactListItemDesktop.csproj.</p>
</li><li>
