    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            if (Windows.Storage.ApplicationData.Current.LocalSettings.Values.ContainsKey("status"))
                Windows.Storage.ApplicationData.Current.LocalSettings.Values["status"] = "";
            if (Windows.Storage.ApplicationData.Current.LocalSettings.Values.ContainsKey("events"))
                Windows.Storage.ApplicationData.Current.LocalSettings.Values["events"] = "";
        ...
        {
            this.UcwaApp.EventChannel.Stop();
        }
    }
}
