...
<p><span style="font-size:small">This sample sets master pages for SharePoint sites by using feature receivers, and deploys master pages without styles or images as starters for branded master pages.</span></p>
