...
<p><span style="font-size:small">This sample creates and deploys custom workflow activities that can be used in SharePoint Designer to extend workflows.</span></p>
