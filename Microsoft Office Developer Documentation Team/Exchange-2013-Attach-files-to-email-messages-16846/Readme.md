...
<p><span style="font-size:small">This sample authenticates an email address and password entered from the console and creates a new email message. It then creates a second email message, which is attached to the first message, and sends the new email message
 to the email address of the authenticated user.</span></p>
<h1>Prerequisites</h1>
...
<ul>
<li><span style="font-size:small">Ex15_SendEmailWithAttachment_CS.sln &mdash; The Visual Studio 2010 solution file for the Ex15_SendEmailWithAttachment_CS project.</span>
</li><li><span style="font-size:small">Ex15_SendEmailWithAttachment_CS.csproj &mdash; The Visual Studio 2010 project file for the
<strong>AddItemAttachment </strong>function.</span> </li><li><span style="font-size:small">app.config &mdash; Contains configuration data for the Ex15_SendEmailWithAttachment_CS project.</span>
</li><li><span style="font-size:small">Ex15_SendEmailWithAttachment_CS.cs &mdash; Contains the using statements, namespace, class, and functions to create an email with an attachment.</span>
...
</li><li><span style="font-size:small">Service.cs &mdash; Contains the using statements, namespace, class, and functions necessary to acquire an ExchangeService object used in the Ex15_SendEmailWithAttachment_CS project.</span>
...
<p><span style="font-size:small">Follow these steps to configure the Exchange 2013: Attach files to email messages programmatically sample.</span></p>
<ol>
<li><span style="font-size:small">Set the startup project to Ex15_SendEmailWithAttachment_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the Project menu.</span>
