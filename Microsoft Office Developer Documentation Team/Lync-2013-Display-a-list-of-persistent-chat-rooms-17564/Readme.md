...
<p><span style="font-size:small">The PersistentChat_FollowedRoomList Lync SDK application demonstrates how to display a list of chat rooms in the user's Lync client contact list. It demonstrates how to use the
<strong>Lync.Model.Room </strong>namespace, and the <strong>RoomManager</strong> class. The application uses the
<strong>RoomManager.FollowedRooms </strong>property to return the collection of followed rooms.</span></p>
