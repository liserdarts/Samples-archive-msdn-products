# Lync 2013: Set presence indicator and view current activity in a WPF app
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to set your Lync 2013 presence and view your current activity in a Windows Presentation Foundation (WPF) application by using a Lync PresenceChooser control.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample, MyPresenceChooserDesktop, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open MyPresenceChooserDesktop.csproj.</p>
</li><li>
