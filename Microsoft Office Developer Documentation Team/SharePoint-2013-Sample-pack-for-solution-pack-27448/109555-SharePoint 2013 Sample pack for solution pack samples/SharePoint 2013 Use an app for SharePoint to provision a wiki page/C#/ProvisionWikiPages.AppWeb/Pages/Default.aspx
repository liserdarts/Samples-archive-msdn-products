<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Contoso.Provision.Pages.AppWeb.Default" ValidateRequest="false" %>
...
<body style="display: none; overflow: auto;">
    ...
    <div style="left: 40px; position: absolute;">
        ...
        HTML text to add:
        <br />
        <asp:TextBox runat="server" ID="txtHtml" Rows="6" TextMode="MultiLine" Width="400px" Text="Hello <strong>GAPPS</strong>!"></asp:TextBox>
        <br />
        <br />
