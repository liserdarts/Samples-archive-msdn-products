...
namespace Contoso.Services.SiteManager.AppWeb
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private SiteManager.SiteManagerClient GetSiteManagerClient()
        {
            ...
            EndpointAddress endPoint = new EndpointAddress(ConfigurationManager.AppSettings["WebApplicationUrl"] + "/_vti_bin/contoso.services.sitemanager/sitemanager.svc");
