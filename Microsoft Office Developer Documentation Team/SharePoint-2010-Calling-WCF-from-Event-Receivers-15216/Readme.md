...
<p><span style="font-size:small">This sample calls a WCF service from an event receiver; after a new item is added to a SharePoint list, the service returns data that is appended to the body of that new item.</span></p>
