# Lync 2013: Add ContactCard controls to a Silverlight app to show contact info
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to create a Lync Contact Card control, assign a SIP URI to the control, and add the contact card to a list box.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to show Lync 2013 contact information for three users by adding three ContactCard controls to a Silverlight application.</p>
<p>This sample, ContactCardSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open ContactCardSilverlight.csproj.</p>
</li><li>
