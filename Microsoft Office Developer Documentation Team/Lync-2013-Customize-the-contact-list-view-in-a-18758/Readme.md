...
<div id="header">Summary: Use this code sample to learn how to create a custom view of the Lync 2013 contact list in a Silverlight application by using two Lync Silverlight controls.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to create a custom contact list item, assign a SIP URI, and add to a custom contact list.</p>
...
<ol>
<li>
<p>Open CustomContactListAndCustomContactListItemSilverlight.csproj.</p>
</li><li>
