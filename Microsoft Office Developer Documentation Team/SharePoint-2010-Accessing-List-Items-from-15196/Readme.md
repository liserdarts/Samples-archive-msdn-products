...
<p><span style="font-size:small">This sample returns items in SharePoint lists (in Silverlight applications) by using the SharePoint Client Object Model.</span></p>
