...
<h1>Introduction</h1>
<p><span style="font-size:small">This sample shows how to use the <strong>NavigateTo
</strong>method to navigate to an object within a Microsoft OneNote 2010 notebook.</span></p>
...
<p><span style="font-size:small">OneNote's Application.NavigateTo method allows you to navigate to a object within OneNote and optionally show the OneNote user interface.</span></p>
<p><span style="font-size:small">Paste all this code into a module, place the cursor within the NavigateToFirstNotebook procedure, and press F5.</span></p>
...
<pre class="hidden">Sub NavigateToFirstNotebook()
...
End Function</pre>
<div class="preview">
<pre class="vb"><span class="visualBasic__keyword">Sub</span>&nbsp;NavigateToFirstNotebook()&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__com">'&nbsp;Get&nbsp;the&nbsp;name&nbsp;of&nbsp;the&nbsp;first&nbsp;notebook.</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__com">'&nbsp;Get&nbsp;the&nbsp;ID&nbsp;so&nbsp;we&nbsp;can&nbsp;use&nbsp;it&nbsp;to&nbsp;open&nbsp;that&nbsp;specific&nbsp;Notebook.</span>&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__com">'&nbsp;Create&nbsp;a&nbsp;message&nbsp;string.</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">Dim</span>&nbsp;strMessage&nbsp;<span class="visualBasic__keyword">As</span>&nbsp;<span class="visualBasic__keyword">String</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;strMessage&nbsp;=&nbsp;<span class="visualBasic__string">&quot;Do&nbsp;you&nbsp;want&nbsp;to&nbsp;navigate&nbsp;to&nbsp;the&nbsp;&quot;</span>&nbsp;&amp;&nbsp;_&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;noteBookName&nbsp;&amp;&nbsp;<span class="visualBasic__string">&quot;&nbsp;notebook?&quot;</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__keyword">If</span>&nbsp;MsgBox(strMessage,&nbsp;vbQuestion&nbsp;&#43;&nbsp;vbYesNo,&nbsp;<span class="visualBasic__string">&quot;Navigate&quot;</span>)&nbsp;=&nbsp;vbYes&nbsp;<span class="visualBasic__keyword">Then</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__com">'&nbsp;If&nbsp;the&nbsp;user&nbsp;clicks&nbsp;Yes,&nbsp;navigate&nbsp;to&nbsp;the&nbsp;first&nbsp;Notebook</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="visualBasic__com">'&nbsp;and&nbsp;show&nbsp;the&nbsp;OneNote&nbsp;user&nbsp;interface.</span>&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;oneNote.NavigateTo&nbsp;notebookID,&nbsp;<span class="visualBasic__string">&quot;&quot;</span>,&nbsp;<span class="visualBasic__keyword">True</span>&nbsp;
...
<ul>
<li><span style="font-size:small"><em><em><a id="26008" href="/site/view/file/26008/1/OneNote.NavigateTo.txt">OneNote.NavigateTo.txt</a>&nbsp;- Download this sample only.<br>
</em></em></span></li><li><span style="font-size:small"><em><em><a id="26009" href="/site/view/file/26009/1/Office%202010%20101%20Code%20Samples.zip">Office 2010 101 Code Samples.zip</a>&nbsp;- Download all the samples.</em></em></span>
</li></ul>
