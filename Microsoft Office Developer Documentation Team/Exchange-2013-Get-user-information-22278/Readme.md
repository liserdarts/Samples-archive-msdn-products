# Exchange 2013: Get user information programmatically
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Get user information programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to display user configuration settings.</p>
</div>
<h1>Description of the Exchange 2013: Get user information programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, uses the Autodiscover service to get a list of user settings that are available on the Exchange server, and then displays those settings on the console.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_GetUserInformation_CS.sln — The Visual Studio 2010 solution file for the Ex15_GetUserInformation_CS project.</p>
</li><li>
<p>Ex15_GetUserInformation_CS.csproj — The Visual Studio 2010 project file for the
<b>GetUserInformation</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_GetUserInformation_CS project.</p>
</li><li>
<p>Ex15_GetUserInformation_CS.cs — Contains the using directives, namespace, class, and functions to get user information from an Exchange server and display it on the console.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_GetUserInformation_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Get user information programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_GetUserInformation_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
...
<ul>
<li>
<p><a href="http://go.microsoft.com/fwlink/?LinkID=255472" target="_blank">Get started with the EWS Managed API</a>
</p>
</li></ul>
</div>
<h1>Change log</h1>
