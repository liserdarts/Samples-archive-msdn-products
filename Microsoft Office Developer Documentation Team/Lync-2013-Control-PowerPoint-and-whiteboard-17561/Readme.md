# Lync 2013: Control PowerPoint and whiteboard sharing sessions from a WPF app
## Requires
* Visual Studio 2010
## License
...
<p><span style="font-size:small">This Lync SDK application demonstrates how to start and accept whiteboard and PowerPoint sharing by using the new
<strong>ContentSharingModality</strong> class. It uses the <strong>AddConversation</strong> method to create a conversation with a remote party, and uses the
<strong>ShareableContent.Upload </strong>method to upload whiteboard and PowerPoint content to a conference.</span></p>
...
<ul>
<li><span style="font-size:small">Conversation class: <a href="http://msdn.microsoft.com/en-us/library/microsoft.lync.model.conversation.conversation_di_3_uc_ocs14mreflyncclnt.aspx">
