...
<p><span style="font-size:small">This sample authenticates an email address and password entered from the console and permanently deletes the contents of a folder that is located in the authenticated user's Inbox folder on the Exchange server. The sample retrieves
 the unique identifier of the folder to be emptied by using the folder's display name, binds to the folder by using its identifier, and empties the folder.</span></p>
<h1>Prerequisites</h1>
...
<ul>
<li><span style="font-size:small">Ex15_EmptyFolder_CS.sln &mdash; The Visual Studio 2010 solution file for the Ex15_EmptyFolder_CS project.</span>
</li><li><span style="font-size:small">Ex15_EmptyFolder_CS.csproj &mdash; The Visual Studio 2010 project file for the
<strong>EmptyFolder </strong>function.</span> </li><li><span style="font-size:small">Ex15_EmptyFolder_CS.cs &mdash; Contains the using statements, namespace, class, and functions to empty a folder.</span>
</li><li><span style="font-size:small">app.config &mdash; Contains configuration data for the Ex15_EmptyFolder_CS project.</span>
...
<strong>ExchangeService </strong>object used in the Ex15_EmptyFolder_CS project.</span>
...
<p><span style="font-size:small">Follow these steps to configure the Exchange 2013: Empty folders on Exchange servers programmatically sample.</span></p>
<ol>
<li><span style="font-size:small">Set the startup project to Ex15_EmptyFolder_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the Project menu.</span>
