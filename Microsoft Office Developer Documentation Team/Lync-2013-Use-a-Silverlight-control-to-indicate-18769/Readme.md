...
<div id="header">Summary: Use this code sample to learn how to display the presence of a set of Lync 2013 users in a list by filling a list with Lync 2013 PresenceIndicator Silverlight controls that can be used to see the presence of the user and start a
 conversation.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to create a Lync Presence Indicator control, assign a SIP URI, and add to a list box.</p>
<p>This sample, PresenceIndicatorSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open PresenceIndicatorSilverlight.csproj.</p>
</li><li>
