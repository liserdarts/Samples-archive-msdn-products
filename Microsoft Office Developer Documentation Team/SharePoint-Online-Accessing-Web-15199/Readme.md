...
<p><span style="font-size:small">This sample connects to SharePoint Online, authenticates by using claims authentication, and then displays the contents of a SharePoint Online list.</span></p>
