...
namespace EX2010_activesyncfolder_cs
{
    class Program
    {
        ...
        // server.
        const string activeSyncServer = "mail.contoso.com";
        ...
        const string domainName = "contoso";
        ...
        const string mailboxCacheLocation = @"C:\Users\jason\Documents\Contoso\Mailbox";
        ...
        static void Main(string[] args)
        {
            ...
            ASFolderSyncResponse folderSyncResponse = 
                (ASFolderSyncResponse)folderSyncRequest.GetResponse();
