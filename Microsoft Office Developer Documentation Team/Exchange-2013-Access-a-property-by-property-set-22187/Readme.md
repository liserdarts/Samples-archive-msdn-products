...
<td align="left"><span id="nsrTitle">Exchange 2013: Access a property by property set GUID and name</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to access an item's property by its property set GUID and its property name.</p>
</div>
<h1>Description of the Exchange 2013: Access a property by property set GUID and name sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, and then searches for an item based on its property set GUID and its property name. We recommend that you use schematized EWS properties when they are available.
</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_AccessPropertyByGUIDName_CS.sln — The Visual Studio 2010 solution file for the Ex15_AccessPropertyByGUIDName_CS project.</p>
</li><li>
<p>Ex15_AccessPropertyByGUIDName_CS.csproj — The Visual Studio 2010 project file for the
<b>AccessMAPIPropertyInPropertySetByGuidAndName</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_AccessPropertyByGUIDName_CS project.</p>
</li><li>
<p>Ex15_AccessPropertyByGUIDName_CS.cs — Contains the using directives, namespace, class, and functions to access a property by its property set GUID and property name.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_AccessPropertyByGUIDName_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Access a property by property set GUID and name sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_AccessPropertyByGUIDName_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
