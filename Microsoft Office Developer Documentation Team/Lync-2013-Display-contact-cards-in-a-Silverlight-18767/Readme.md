# Lync 2013: Display contact cards in a Silverlight app
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to display your Lync 2013 contact card in a Silverlight application by using a Lync MyStatusArea control.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample, MyStatusAreaSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open MyStatusAreaSilverlight.csproj.</p>
</li><li>
