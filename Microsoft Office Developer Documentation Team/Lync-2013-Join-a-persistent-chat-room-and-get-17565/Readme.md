...
<p><span style="font-size:small">The PersistentChat_GetMessages Lync SDK application uses the
<strong>RoomManager.FollowedRooms </strong>property to load a list of the followed rooms, and uses the following asynchronous methods to retrieve messages from those rooms:</span></p>
<ul>
<li><strong><span style="font-size:small">Room.BeginRetrieveLatestMessages()</span></strong>
</li><li><strong><span style="font-size:small">Room.BeginRetrieveAdditionalMessages()</span></strong>
</li></ul>
