# Lync 2013: Search contacts from a Silverlight app adding a ContactSearch control
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to add Lync 2013 contact search capability to a Silverlight application by adding a single Lync ContactSearch control to the application.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to create a Lync contact search control, and how to switch between search type (Skill and Name).</p>
<p>This sample, ContactSearchSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<p>Silverlight 5 SDK</p>
</li><li>
<p>Silverlight 5 Tools for Visual Studio 2010</p>
</li><li>
...
<ol>
<li>
<p>Open ContactSearchSilverlight.csproj.</p>
</li><li>
