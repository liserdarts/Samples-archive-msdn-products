# Exchange 2013: Perform paged searches programmatically on Exchange servers
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Perform paged searches programmatically on Exchange servers</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to perform a paged search.</p>
</div>
<h1>Description of the Exchange 2013: Perform paged searches programmatically on Exchange servers sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, and then performs a paged search of the Inbox.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_PerformPagedSearch_CS.sln — The Visual Studio 2010 solution file for the Ex15_PerformPagedSearch_CS project.</p>
</li><li>
<p>Ex15_PerformPagedSearch_CS.csproj — The Visual Studio 2010 project file for the
<b>PerformPagedSearch</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_PerformPagedSearch_CS project.</p>
</li><li>
<p>Ex15_PerformPagedSearch_CS.cs — Contains the using statements, namespace, class, and functions to perform a paged search of the inbox.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_PerformPagedSearch_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Perform paged searches programmatically on Exchange servers sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_PerformPagedSearch_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
...
<ul>
<li>
<p><a href="http://msdn.microsoft.com/en-us/library/jj220499(EXCHG.80).aspx" target="_blank">Get started with the EWS Managed API</a>
</p>
</li></ul>
</div>
<h1>Change log</h1>
