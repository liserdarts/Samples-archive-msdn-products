...
namespace UCourseSelector.Office365
{
    public abstract class Office365ServiceInfo
    {
        ...
        private class SharePointServiceInfo : Office365ServiceInfo
        {
            /// <summary>
            /// This constructor is intentionally private, and should not be used.
            /// Instead, callers should create a new instance by calling the static CreateAsync() method
            /// </summary>
            private SharePointServiceInfo() { }
        ...
        private class OneDriveServiceInfo : Office365ServiceInfo
        {
            /// <summary>
            /// This constructor is intentionally private, and should not be used.
            /// Instead, callers should create a new instance by calling the static CreateAsync() method
            /// </summary>
            private OneDriveServiceInfo() { }
