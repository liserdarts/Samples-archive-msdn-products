# Lync 2013: Start an IM conversation by using automation
## Requires
* Visual Studio 2010
## License
...
<div id="header">Summary: Use this code sample to learn how to start a new conversation with one Lync contact by using the
<span class="label">Automation</span> class.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to use the <span class="label">Automation</span> class in the Lync Model API to start a new conversation with one Lync contact.</p>
<p>Sample features:</p>
<ul>
<li>
<p>Use the Automation API in Lync to start a new conversation with new Lync contacts.</p>
</li><li>
<p>Start conversation with IM modalities.</p>
</li></ul>
<p>This sample, StartConversation, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open StartConversation.csproj.</p>
</li><li>
<p>In Visual Studio, press F5.</p>
</li><li>
<p>In the participant box, add SIP URI or contact address.</p>
</li><li>
<p>Click <span class="ui">Start Conversation</span>.</p>
</li></ol>
</div>
