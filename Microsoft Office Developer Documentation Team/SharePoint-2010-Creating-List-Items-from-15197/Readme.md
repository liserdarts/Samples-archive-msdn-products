...
<p><span style="font-size:small">This sample creates SharePoint list items by calling the SharePoint Client Object Model from Silverlight applications.</span></p>
