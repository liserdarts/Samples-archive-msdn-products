...
namespace SharePoint.Workflow.ExcelGenerator.Workflow1
{
    public sealed partial class Workflow1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.createAndPublishExcelDocument = new System.Workflow.Activities.CodeActivity();
            this.onWorkflowActivated1 = new Microsoft.SharePoint.WorkflowActions.OnWorkflowActivated();
            // 
            // createAndPublishExcelDocument
            // 
            this.createAndPublishExcelDocument.Name = "createAndPublishExcelDocument";
            this.createAndPublishExcelDocument.ExecuteCode += new System.EventHandler(this.createAndPublishExcelDocument_ExecuteCode);
            ...
            this.Activities.Add(this.createAndPublishExcelDocument);
            this.Name = "Workflow1";
        ...
        private CodeActivity createAndPublishExcelDocument;
