# Exchange 2013: Create folders by impersonating another email account
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Create folders by impersonating another email account</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to create a folder for an email account by using impersonation.</p>
</div>
<h1>Description of the Exchange 2013: Create folders by impersonating another email account sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, and then uses impersonation to enable a service account to create a folder for another email account.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_CreateFolderUsingImpersonation_CS.sln — The Visual Studio 2010 solution file for the Ex15_CreateFolderUsingImpersonation_CSproject.</p>
</li><li>
<p>Ex15_CreateFolderUsingImpersonation_CS.csproj — The Visual Studio 2010 project file for the
<b>CreateFolderUsingImpersonation</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_CreateFolderUsingImpersonation_CS project.</p>
</li><li>
<p>Ex15_CreateFolderUsingImpersonation_CS.cs — Contains the using directives, namespace, class, and functions for using impersonation to create a folder in an email account.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_CreateFolderUsingImpersonation_CSproject.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Create folders by impersonating another email account sample.</p>
<ol>
<li>
<p>Set the startup project toEx15_CreateFolderUsingImpersonation_CS by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
