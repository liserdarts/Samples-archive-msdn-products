...
Partial Public NotInheritable Class ThisAddIn
    ...
    Public Sub New(ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(AddressOf Globals.GetFactory, serviceProvider, "AddIn", "ThisAddIn")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
     Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.Tools.Office.ProgrammingModel.dll", "10.0.0.0"),  _
     Global.System.ComponentModel.EditorBrowsableAttribute(Global.System.ComponentModel.EditorBrowsableState.Never)>  _
    Friend Shared Function GetFactory(ByVal serviceProvider As Global.System.IServiceProvider) As Global.Microsoft.Office.Tools.Outlook.Factory
        If (_factory Is Nothing) Then
            _factory = CType(serviceProvider.GetService(GetType(Global.Microsoft.Office.Tools.Outlook.Factory)), Global.Microsoft.Office.Tools.Outlook.Factory)
        End If
        Return _factory
    End Function
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    Inherits Microsoft.Office.Tools.CollectionBase(Of Microsoft.Office.Tools.Outlook.IFormRegion)
