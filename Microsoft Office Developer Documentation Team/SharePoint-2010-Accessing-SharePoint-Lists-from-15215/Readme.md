...
<p><span style="font-size:small">This sample writes a WCF service that returns all the items in SharePoint lists, and includes a sample client console application to test the service.</span></p>
