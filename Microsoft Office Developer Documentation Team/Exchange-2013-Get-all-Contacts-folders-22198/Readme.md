# Exchange 2013: Get all Contacts folders programmatically
## Requires
* Visual Studio 2010
## License
...
<td align="left"><span id="nsrTitle">Exchange 2013: Get all Contacts folders programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to get all Contacts folders.</p>
</div>
<h1>Description of the Exchange 2013: Get all Contacts folders programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, binds to the default Contacts folder, and then returns all the child folders of the default Contacts folder.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_GetAllContactsFolders_CS.sln — The Visual Studio 2010 solution file for the Ex15_GetAllContactsFolders_CS project.</p>
</li><li>
<p>Ex15_GetAllContactsFolders_CS.csproj — The Visual Studio 2010 project file for the
<b>GetAllContactsFolders</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the Ex15_GetAllContactsFolders_CS project.</p>
</li><li>
<p>Ex15_GetAllContactsFolders_CS.cs — Contains the using statements, namespace, class, and functions to get all the Contacts folders in a user's mailbox.</p>
</li><li>
...
<b>ExchangeService</b> object used in the Ex15_GetAllContactsFolders_CS project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Get all Contacts folders programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_GetAllContactsFolders_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
