...
<td align="left"><span id="nsrTitle">Exchange 2013: Provision X-headers programmatically</span>
</td>
</tr>
</tbody>
</table>
...
<p></p>
<div>
<p>This sample shows you how to use the Exchange Web Services (EWS) Managed API to provision X-headers for Exchange mailboxes.</p>
</div>
<h1>Description of the Exchange 2013: Provision X-headers programmatically sample</h1>
<div id="sectionSection0" name="collapseableSection">
<p>This sample authenticates an email address and password entered from the console, and then saves an item with a custom X-header. This sample provisions a custom X-header for a mailbox database in Exchange 2007, and provisions a custom X-header for a user's
 mailbox for versions of Exchange starting with Exchange 2010, including Exchange Online.</p>
</div>
<h1>Prerequisites</h1>
...
<ul>
<li>
<p>Ex15_ProvisionCustomXHeader_CS.sln — The Visual Studio 2010 solution file for the ProvisionCustomXHeader project.</p>
</li><li>
<p>Ex15_ProvisionCustomXHeader_CS.csproj — The Visual Studio 2010 project file for the
<b>ProvisionCustomXHeader</b> function.</p>
</li><li>
<p>app.config — Contains configuration data for the ProvisionCustomXHeader project.</p>
</li><li>
<p>Ex15_ProvisionCustomXHeader_CS.cs — Contains the using directives, namespace, class, and functions to provision an X-header in a user's mailbox or a mailbox database.</p>
</li><li>
...
<b>ExchangeService</b> object used in the ProvisionCustomXHeader project.</p>
</li><li>
...
<p>Follow these steps to configure the Exchange 2013: Provision X-headers programmatically sample.</p>
<ol>
<li>
<p>Set the startup project to Ex15_ProvisionCustomXHeader_CS.csproj by selecting the project in the Solution Explorer and choosing &quot;Set as StartUp Project&quot; from the
