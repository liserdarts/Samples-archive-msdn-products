...
<div id="header">Summary: Use this code sample to learn how to start a new Lync 2013 conversation from a Silverlight application by using a Lync conversation Silverlight control.</div>
<div id="mainSection">
<div id="mainBody">
...
<p>This sample demonstrates how to start a new Lync 2013 conversation from a Silverlight application by using any of the Lync conversation Silverlight controls.</p>
<p>This sample, ButtonsSilverlight, is distributed with the Lync 2013 SDK. The Lync 2013 SDK includes three development models:</p>
<ul>
<li>
<p>Lync Controls</p>
</li><li>
...
<ol>
<li>
<p>Open ButtonsSilverlight.csproj.</p>
</li><li>
